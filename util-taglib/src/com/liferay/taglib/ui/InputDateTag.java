...
public class InputDateTag extends BaseValidatorTagSupport {
	...
	public void setDateClearButtonLabel(String dateClearButtonLabel) {
		_dateClearButtonLabel = dateClearButtonLabel;
	}
	...
	protected void setAttributes(HttpServletRequest request) {
		...
		request.setAttribute(
			"liferay-ui:input-date:dateClearButtonLabel",
			_dateClearButtonLabel);
		request.setAttribute(
	...
	private String _dateClearButtonLabel;
