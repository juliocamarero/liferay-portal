...
create index IX_E2DEA18C on JournalArticle (classNameId, templateKey);
...
create index IX_AB27C829 on JournalArticle (groupId, classNameId, structureKey);
create index IX_93562C0C on JournalArticle (groupId, classNameId, templateKey);
...
create index IX_960C2285 on JournalArticle (groupId, structureKey);
create index IX_2F8F1630 on JournalArticle (groupId, templateKey);
...
create index IX_4278D805 on JournalArticle (structureKey);
create index IX_8FF5B0B0 on JournalArticle (templateKey);
