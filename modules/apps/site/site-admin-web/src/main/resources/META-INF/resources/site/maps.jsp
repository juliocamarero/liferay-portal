...
<liferay-frontend-map:bla />

<liferay-frontend:add-menu>
	<liferay-frontend:add-menu-item title="Bla bla bla" url="http://testURL" />
</liferay-frontend:add-menu>

<liferay-application-list:panel-app active="<%= false %>" id="testing" label="bla bla" url="/test" />
