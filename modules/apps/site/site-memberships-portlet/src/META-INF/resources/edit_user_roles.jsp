...
portletURL.setParameter("mvcPath", "/edit_user_roles.jsp");
...
<aui:form action="<%= portletURL.toString() %>" method="post" name="fm">
	...
	<c:choose>
		<c:when test="<%= role == null %>">
			<liferay-util:include page="/edit_user_roles_role.jsp" servletContext="<%= application %>" />
		</c:when>
		<c:otherwise>
			<liferay-util:include page="/edit_user_roles_users.jsp" servletContext="<%= application %>" />
		</c:otherwise>
	</c:choose>
</aui:form>
