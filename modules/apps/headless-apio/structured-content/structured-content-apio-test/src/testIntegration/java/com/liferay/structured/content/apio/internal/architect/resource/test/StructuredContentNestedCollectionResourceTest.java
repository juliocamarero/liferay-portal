...
public class StructuredContentNestedCollectionResourceTest {
	...
	public void testGetPageItems() throws Exception {
		...
		PageItems<JournalArticle> pageItems = _getPageItems(
			...
			_getThemeDisplay(_group), null, new Sort(Collections.emptyList()));
	...
	@Test
	public void testGetPageItemsFilteredByTitle() throws Exception {
	...
	@Test
	public void testGetPageItemsFilteredByTitleWithDifferentCaseInTheFilter()
		throws Exception {
	...
	@Test
	public void testGetPageItemsFilteredByTitleWithDifferentCaseInTheTitle()
		throws Exception {
