...
<%
BreadcrumbPortletInstanceConfiguration breadcrumbPortletInstanceConfiguration = (BreadcrumbPortletInstanceConfiguration)renderRequest.getAttribute(BreadcrumbPortletInstanceConfiguration.class.getName());
