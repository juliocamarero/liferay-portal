...
<liferay-util:dynamic-include key="<%= AssetPublisherPortletKeys.DYNAMIC_INCLUDE_VIEW_CONTENT_PRE %>" />
...
<liferay-util:dynamic-include key="<%= AssetPublisherPortletKeys.DYNAMIC_INCLUDE_VIEW_CONTENT_POST %>" />