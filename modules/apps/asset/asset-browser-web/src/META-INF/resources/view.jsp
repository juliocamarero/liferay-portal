...
boolean includeNonListable = ParamUtil.getBoolean(request, "includeNonListable", false);
	...
	<aui:form action="<%= portletURL %>" method="post" name="selectAssetFm">
		...
		>
			...
			<liferay-ui:search-container-results>
				<c:choose>
					<c:when test="<%= includeNonListable || AssetBrowserWebConfigurationValues.SEARCH_WITH_DATABASE %>">
