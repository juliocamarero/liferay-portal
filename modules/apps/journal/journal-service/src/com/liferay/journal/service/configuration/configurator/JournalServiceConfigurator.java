 ...
 */
@Component(immediate = true, service = JournalServiceConfigurator.class)
public class JournalServiceConfigurator {
	...
	protected ClassLoader getClassLoader() {
		Class<? extends JournalServiceConfigurator> clazz = getClass();
