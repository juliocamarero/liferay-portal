...
public interface IFramePortletInstanceConfiguration {
	...
	@Meta.AD(deflt = "", required = false)
	public String authType(String defaultAuthType);
	...
	@Meta.AD(deflt = "", required = false)
	public String formMethod(String defaultFormMethod);
	...
	@Meta.AD(deflt = "", required = false)
	public String hiddenVariables(String defaultHiddenValues);
