...
<liferay-util:dynamic-include key="<%= BlogsPortletKeys.DYNAMIC_INCLUDE_VIEW_ENTRY_PRE %>" />
...
<liferay-util:dynamic-include key="<%= BlogsPortletKeys.DYNAMIC_INCLUDE_VIEW_ENTRY_POST %>" />