...
public class ${entity.name}ModelImpl extends BaseModelImpl<${entity.name}> implements ${entity.name}Model {
	...
	<#list entity.regularColList as column>
		...
		<#if (entity.isAuditedModel() || entity.isStagedModel()) && (column.name == "modifiedDate")>
	...
	public void resetOriginalValues() {
		<#list entity.regularColList as column>
			<#if column.isFinderPath() || ((parentPKColumn != "") && (parentPKColumn.name == column.name)) || ((column.type == "Blob") && column.lazy) || (entity.isAuditedModel() || entity.isStagedModel())>
