...
<c:if test="<%= !locale.equals(user.getLocale()) %>">
	...
	<c:if test="<%= ArrayUtil.contains(availableLocales, userLocale) %>">
		...
		<%
		String displayPreferredLanguageURLString = themeDisplay.getPathMain() + "/portal/update_language?redirect=" + currentURL + "&languageId=" + user.getLanguageId() + "&persistState=" + Boolean.FALSE.toString() + "&showUserLocaleOptionsMessage=" + Boolean.FALSE.toString();
		%>
	...
	<%
	String changePreferredLanguageURLString = themeDisplay.getPathMain() + "/portal/update_language?redirect=" + currentURL + "&languageId=" + themeDisplay.getLanguageId() + "&showUserLocaleOptionsMessage=" + Boolean.FALSE.toString();
	%>
