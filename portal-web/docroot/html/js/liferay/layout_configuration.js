			...
			A.mix(
				LayoutConfiguration,
				{
					...
					init: function() {
						...
						var menu = A.one('#portal_add_content_and_application');
							...
							new A.LiveSearch(
								{
									...
									input: searchInput,
									nodes: '#portal_add_content_and_application .lfr-portlet-item',
									show: function(node) {
										node.show();
							...
							new A.LiveSearch(
								{
									...
									input: searchInput,
									nodes: '#portal_add_content_and_application .lfr-add-content'
								}
							);
						}
					},
					...
					_loadContent: function() {
						...
						instance._dialogBody = A.one('#portal_add_content_and_application');
						...
						var portletItemOptions = {
							delegateConfig: {
								container: '#portal_add_content_and_application',
								dragConfig: {
									clickPixelThresh: 0,
									clickTimeThresh: 0
								},
