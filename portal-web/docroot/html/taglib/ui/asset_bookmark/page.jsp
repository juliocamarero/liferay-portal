...
boolean isFavorite = AssetBookmarkServiceUtil.isFavorite(userId, className, classPK);
String starId = portletDisplay.getNamespace() + "favoriteStar" + String.valueOf(classPK);
%>

<a class="aui-rating-element <%= isFavorite ? "aui-rating-element-on" : StringPool.BLANK %>" href="javascript:;" id="<%= starId %>" title='<%= isFavorite ? LanguageUtil.get(pageContext, "bookmark-this") : LanguageUtil.get(pageContext, "un-bookmark-this") %>'></a>
