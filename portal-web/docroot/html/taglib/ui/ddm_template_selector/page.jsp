...
long ddmTemplateGroupId = PortletDisplayTemplateUtil.getDDMTemplateGroupId(displayStyleGroupId);
	...
	displayStyleSelect.on(
		...
		function(event) {
			...
			if (selectedIndex >= 0) {
				...
				var groupId = selectedOption.attr('data-groupId');

				if (groupId) {
					displayStyleGroupIdInput.set('value', groupId);
				}
			}
		}
	);
