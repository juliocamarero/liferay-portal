...
String templateKey = GetterUtil.getString((String)request.getAttribute("liferay-ui:journal-article:templateId"));
...
JournalArticleDisplay articleDisplay = JournalContentUtil.getDisplay(groupId, articleId, templateKey, null, languageId, articlePage, portletRequestModel, themeDisplay);
%>
