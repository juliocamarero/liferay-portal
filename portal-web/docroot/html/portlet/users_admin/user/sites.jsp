...
>
	...
	>
		...
		<c:if test="<%= !portletName.equals(PortletKeys.MY_ACCOUNT) && !mandatoryGroups.contains(group) && !GroupPermissionUtil.hasAdminAndOwnerRoleRestriction(permissionChecker, group.getGroupId(), selUser.getUserId()) %>">
			<liferay-ui:search-container-column-text>
