		...
		<aui:form action='<%= exportPortletURL + "&etag=0&strip=0" %>' cssClass="lfr-export-dialog" method="post" name="fm1">
			...
			<div class="export-dialog-tree">
				...
				<c:if test="<%= !portletDataHandler.isDisplayPortlet() %>">
					...
					<%
					DateRange dateRange = ExportImportDateUtil.getDateRange(renderRequest, themeDisplay.getScopeGroupId(), exportableLayout.getPlid(), selPortlet.getPortletId(), ExportImportDateUtil.RANGE_ALL);
