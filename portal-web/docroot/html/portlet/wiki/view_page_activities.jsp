...
>
	...
	>
		...
		<c:choose>
			<c:when test="<%= isAttachmentActivity(activity.getType()) && isAttachmentLastActivity(activity.getType(), fileEntry.getFileEntryId()) %>">

				<%
				attachmentLastActivityMap.put(fileEntry.getFileEntryId(),-1);			
				%>
...
public boolean isAttachmentLastActivity(int curActivityType, long fileEntryId) {
