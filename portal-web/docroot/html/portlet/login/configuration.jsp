...
<aui:form action="<%= configurationActionURL %>" method="post" name="fm">
	...
	>
		...
		<liferay-ui:section>
			...
			<aui:fieldset>
				<liferay-ui:email-notifications-settings
					emailBody='<%= LocalizationUtil.getLocalizationXmlFromPreferences(portletPreferences, renderRequest, "emailPasswordSentBody") %>'
					...
					emailSubject='<%= LocalizationUtil.getLocalizationXmlFromPreferences(portletPreferences, renderRequest, "emailPasswordSentSubject") %>'
		...
		<liferay-ui:section>
			...
			<aui:fieldset>
				<liferay-ui:email-notifications-settings
					emailBody='<%= LocalizationUtil.getLocalizationXmlFromPreferences(portletPreferences, renderRequest, "emailPasswordResetBody") %>'
					emailDefinitionTerms="<%= LoginUtil.getEmailDefinitionTerms(renderRequest, emailFromAddress, emailFromName, true) %>"
					emailParam="emailPasswordReset"
					emailSubject='<%= LocalizationUtil.getLocalizationXmlFromPreferences(portletPreferences, renderRequest, "emailPasswordResetSubject") %>'
					showEmailEnabled="<%= false %>"
				/>
			</aui:fieldset>
		</liferay-ui:section>
