	...
	<aui:fieldset>
		...
		<div class="<%= assetCategoriesNavigationDisplayContext.isAllAssetVocabularies() ? "hide" : "" %>" id="<portlet:namespace />assetVocabulariesBoxes">
			<liferay-ui:input-move-boxes
				...
				leftList="<%= assetCategoriesNavigationDisplayContext.getCurrentAssetVocabularies() %>"
				leftReorder="true"
				leftTitle="current"
				rightBoxName="availableAssetVocabularyIds"
				rightList="<%= assetCategoriesNavigationDisplayContext.getAvailableAssetVocabularies() %>"
