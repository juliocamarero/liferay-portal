...
<div class="content-preview">
	...
	if (Validator.isNotNull(assetRenderer.getDisplayDate())) {
		Format dateFormatDate = FastDateFormatFactoryUtil.getSimpleDateFormat("MMMM d, yyyy", locale, timeZone);

		displayDate = CharPool.OPEN_PARENTHESIS + dateFormatDate.format(assetRenderer.getDisplayDate()) + CharPool.CLOSE_PARENTHESIS;
	}
	%>
