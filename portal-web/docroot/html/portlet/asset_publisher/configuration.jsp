...
List<AssetRendererFactory> assetRendererFactoriesWithTypes = new ArrayList<AssetRendererFactory>();
	...
	<c:if test="<%= typeSelection.equals(StringPool.BLANK) %>">
		...
		<liferay-util:buffer var="selectAssetTypeInput">
			...
			for (AssetRendererFactory assetRendererFactory : AssetRendererFactoryRegistryUtil.getAssetRendererFactories()) {
				...
				assetRendererFactoriesWithTypes.add(assetRendererFactory);
...
<aui:script>
	...
	Liferay.provide(
		...
		function() {
			...
			<%
			for (AssetRendererFactory curRendererFactory : assetRendererFactoriesWithTypes) {
