...
Map<String, Map<String, String>> classTypeFieldNames = assetRendererFactory.getClassTypeFieldNames(classTypeId, locale);
...
<div id="<portlet:namespace />selectDDMStructureFieldForm">
	...
	>
		<liferay-ui:search-container-results
			results="<%= ListUtil.fromMapKeys(classTypeFieldNames) %>"
		...
		>
			...
			<%
			Map<String, String> attributes = classTypeFieldNames.get(fieldName);

			String label = HtmlUtil.escapeAttribute(attributes.get("label"));
			%>
