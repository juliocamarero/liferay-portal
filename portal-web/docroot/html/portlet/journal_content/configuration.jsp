...
<aui:form action="<%= configurationActionURL %>" method="post" name="fm1">
	...
	<c:if test="<%= article != null %>">
		...
		<%
		DDMStructure ddmStructure = DDMStructureLocalServiceUtil.fetchStructure(article.getGroupId(), PortalUtil.getClassNameId(JournalArticle.class), article.getStructureKey(), true);
		...
		if (!ddmTemplates.isEmpty()) {
			if (Validator.isNull(ddmTemplateKey)) {
				ddmTemplateKey = article.getTemplateKey();
			}
		%>
