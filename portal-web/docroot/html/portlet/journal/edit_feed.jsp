...
<aui:form action="<%= editFeedURL %>" enctype="multipart/form-data" method="post" name="fm" onSubmit='<%= "event.preventDefault(); " + renderResponse.getNamespace() + "saveFeed();" %>'>
	...
	<aui:fieldset>
		...
		<aui:input cssClass="lfr-input-text-container" field="targetLayoutFriendlyUrl" helpMessage="journal-feed-target-layout-friendly-url-help" name="targetLayoutFriendlyURL" />
