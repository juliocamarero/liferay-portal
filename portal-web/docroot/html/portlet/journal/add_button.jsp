...
List<DDMStructure> ddmStructures = JournalFolderLocalServiceUtil.getFolderDDMStructures(PortalUtil.getCurrentAndAncestorSiteGroupIds(scopeGroupId), folderId, inherited);
%>
