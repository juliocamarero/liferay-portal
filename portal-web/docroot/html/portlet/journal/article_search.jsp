...
>
	...
	<aui:fieldset>
		...
		<c:if test="<%= !portletName.equals(PortletKeys.JOURNAL) || ((themeDisplay.getScopeGroupId() == themeDisplay.getCompanyGroupId()) && (Validator.isNotNull(displayTerms.getStructureKey()) || Validator.isNotNull(displayTerms.getTemplateKey()))) %>">
			...
			<aui:select inlineField="<%= true %>" label="my-sites" name="<%= displayTerms.GROUP_ID %>" showEmptyOption="<%= (themeDisplay.getScopeGroupId() == themeDisplay.getCompanyGroupId()) && (Validator.isNotNull(displayTerms.getStructureKey()) || Validator.isNotNull(displayTerms.getTemplateKey())) %>">
