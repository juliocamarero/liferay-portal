...
public class RatingsEntryPersistenceImpl extends BasePersistenceImpl<RatingsEntry>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !RatingsEntryModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((ratingsEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(ratingsEntryModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(ratingsEntryModelImpl.getCompanyId())
					};
	...
	/**
	 * Returns all the ratings entries where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching ratings entries
	 * @throws SystemException if a system exception occurred
	 */
	public List<RatingsEntry> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the ratings entries where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<RatingsEntry> findByCompanyId(long companyId, int start, int end)
		throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the ratings entries where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<RatingsEntry> findByCompanyId(long companyId, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (RatingsEntry ratingsEntry : list) {
				if ((companyId != ratingsEntry.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first ratings entry in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public RatingsEntry findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		List<RatingsEntry> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last ratings entry in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public RatingsEntry findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		int count = countByCompanyId(companyId);

		List<RatingsEntry> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the ratings entries before and after the current ratings entry in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public RatingsEntry[] findByCompanyId_PrevAndNext(long entryId,
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, ratingsEntry,
					companyId, orderByComparator, true);

			array[1] = ratingsEntry;

			array[2] = getByCompanyId_PrevAndNext(session, ratingsEntry,
	...
	protected RatingsEntry getByCompanyId_PrevAndNext(Session session,
		RatingsEntry ratingsEntry, long companyId,
	...
	/**
	 * Removes all the ratings entries where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (RatingsEntry ratingsEntry : findByCompanyId(companyId)) {
			remove(ratingsEntry);
		}
	}
	...
	/**
	 * Returns the number of ratings entries where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "ratingsEntry.companyId = ?";
