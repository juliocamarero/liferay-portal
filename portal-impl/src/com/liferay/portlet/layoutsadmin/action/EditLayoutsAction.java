...
public class EditLayoutsAction extends PortletAction {
	...
	public void processAction(
		...
		try {
			...
			else if (cmd.equals("add_pages_set")) {
				addPagesSet(actionRequest);
			}
	...
	protected void addPagesSet(ActionRequest actionRequest) throws Exception {
		...
		typeSettingsProperties.setProperty(
			"sharedContent", Boolean.TRUE.toString());
