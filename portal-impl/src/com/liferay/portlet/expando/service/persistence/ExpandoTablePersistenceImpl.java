...
public class ExpandoTablePersistenceImpl extends BasePersistenceImpl<ExpandoTable>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(ExpandoTableModelImpl.ENTITY_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(ExpandoTableModelImpl.ENTITY_CACHE_ENABLED,
	...
	/**
	 * Returns all the expando tables where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching expando tables
	 * @throws SystemException if a system exception occurred
	 */
	public List<ExpandoTable> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the expando tables where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ExpandoTable> findByCompanyId(long companyId, int start, int end)
		throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the expando tables where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ExpandoTable> findByCompanyId(long companyId, int start,
	...
	/**
	 * Returns the first expando table in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ExpandoTable findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchTableException, SystemException {
		List<ExpandoTable> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last expando table in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ExpandoTable findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchTableException, SystemException {
		int count = countByCompanyId(companyId);

		List<ExpandoTable> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the expando tables before and after the current expando table in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ExpandoTable[] findByCompanyId_PrevAndNext(long tableId,
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, expandoTable,
					companyId, orderByComparator, true);

			array[1] = expandoTable;

			array[2] = getByCompanyId_PrevAndNext(session, expandoTable,
	...
	protected ExpandoTable getByCompanyId_PrevAndNext(Session session,
		ExpandoTable expandoTable, long companyId,
	...
	/**
	 * Removes all the expando tables where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (ExpandoTable expandoTable : findByCompanyId(companyId)) {
			remove(expandoTable);
		}
	}
	...
	/**
	 * Returns the number of expando tables where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "expandoTable.companyId = ?";
