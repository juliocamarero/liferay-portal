...
public class ExpandoRowPersistenceImpl extends BasePersistenceImpl<ExpandoRow>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(ExpandoRowModelImpl.ENTITY_CACHE_ENABLED,
			...
			ExpandoRowModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(ExpandoRowModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !ExpandoRowModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((expandoRowModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(expandoRowModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(expandoRowModelImpl.getCompanyId())
					};
	...
	/**
	 * Returns all the expando rows where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching expando rows
	 * @throws SystemException if a system exception occurred
	 */
	public List<ExpandoRow> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the expando rows where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ExpandoRow> findByCompanyId(long companyId, int start, int end)
		throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the expando rows where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<ExpandoRow> findByCompanyId(long companyId, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ExpandoRow expandoRow : list) {
				if ((companyId != expandoRow.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first expando row in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ExpandoRow findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchRowException, SystemException {
		List<ExpandoRow> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last expando row in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ExpandoRow findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchRowException, SystemException {
		int count = countByCompanyId(companyId);

		List<ExpandoRow> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the expando rows before and after the current expando row in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ExpandoRow[] findByCompanyId_PrevAndNext(long rowId, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchRowException, SystemException {
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, expandoRow,
					companyId, orderByComparator, true);

			array[1] = expandoRow;

			array[2] = getByCompanyId_PrevAndNext(session, expandoRow,
	...
	protected ExpandoRow getByCompanyId_PrevAndNext(Session session,
		ExpandoRow expandoRow, long companyId,
	...
	/**
	 * Removes all the expando rows where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (ExpandoRow expandoRow : findByCompanyId(companyId)) {
			remove(expandoRow);
		}
	}
	...
	/**
	 * Returns the number of expando rows where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "expandoRow.companyId = ?";
