...
public class JournalFolderPersistenceImpl extends BasePersistenceImpl<JournalFolder>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_ = "journalFolder.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_ = "journalFolder.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_ = "(journalFolder.uuid_ IS NULL OR journalFolder.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1_ = "journalFolder.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_ = "journalFolder.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_ = "(journalFolder.uuid_ IS NULL OR journalFolder.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_ = "journalFolder.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_ = "journalFolder.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_ = "(journalFolder.uuid_ IS NULL OR journalFolder.uuid_ = ?) AND ";
