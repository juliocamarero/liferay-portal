...
public class JournalArticlePersistenceImpl extends BasePersistenceImpl<JournalArticle>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_R_NOTC_LTD_I_ST =
		new FinderPath(JournalArticleModelImpl.ENTITY_CACHE_ENABLED,
			JournalArticleModelImpl.FINDER_CACHE_ENABLED,
			JournalArticleImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByR_NotC_LtD_I_ST",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_R_NOTC_LTD_I_ST =
		new FinderPath(JournalArticleModelImpl.ENTITY_CACHE_ENABLED,
			JournalArticleModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByR_NotC_LtD_I_ST",
			new String[] {
				Long.class.getName(), Long.class.getName(), Date.class.getName(),
				Boolean.class.getName(), Integer.class.getName()
			});
	...
	/**
	 * Returns all the journal articles where resourcePrimKey = &#63; and classNameId &ne; &#63; and displayDate &lt; &#63; and indexable = &#63; and status = &#63;.
	 *
	 * @param resourcePrimKey the resource prim key
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public List<JournalArticle> findByR_NotC_LtD_I_ST(long resourcePrimKey,
		long classNameId, Date displayDate, boolean indexable, int status)
		throws SystemException {
		return findByR_NotC_LtD_I_ST(resourcePrimKey, classNameId, displayDate,
			indexable, status, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the journal articles where resourcePrimKey = &#63; and classNameId &ne; &#63; and displayDate &lt; &#63; and indexable = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.journal.model.impl.JournalArticleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<JournalArticle> findByR_NotC_LtD_I_ST(long resourcePrimKey,
		...
		int start, int end) throws SystemException {
		return findByR_NotC_LtD_I_ST(resourcePrimKey, classNameId, displayDate,
			indexable, status, start, end, null);
	}

	/**
	 * Returns an ordered range of all the journal articles where resourcePrimKey = &#63; and classNameId &ne; &#63; and displayDate &lt; &#63; and indexable = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.journal.model.impl.JournalArticleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<JournalArticle> findByR_NotC_LtD_I_ST(long resourcePrimKey,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_R_NOTC_LTD_I_ST;
		finderArgs = new Object[] {
				resourcePrimKey, classNameId, displayDate, indexable, status,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_R_NOTC_LTD_I_ST_RESOURCEPRIMKEY_2);

			query.append(_FINDER_COLUMN_R_NOTC_LTD_I_ST_CLASSNAMEID_2);

			boolean bindDisplayDate = false;

			if (displayDate == null) {
				query.append(_FINDER_COLUMN_R_NOTC_LTD_I_ST_DISPLAYDATE_1);
			}
			else {
				bindDisplayDate = true;

				query.append(_FINDER_COLUMN_R_NOTC_LTD_I_ST_DISPLAYDATE_2);
			}

			query.append(_FINDER_COLUMN_R_NOTC_LTD_I_ST_INDEXABLE_2);

			query.append(_FINDER_COLUMN_R_NOTC_LTD_I_ST_STATUS_2);
	...
	/**
	 * Returns the first journal article in the ordered set where resourcePrimKey = &#63; and classNameId &ne; &#63; and displayDate &lt; &#63; and indexable = &#63; and status = &#63;.
	 *
	 * @param resourcePrimKey the resource prim key
	 * @param classNameId the class name ID
	 * @param displayDate the display date
	 ...
	 */
	@Override
	public JournalArticle findByR_NotC_LtD_I_ST_First(long resourcePrimKey,
		long classNameId, Date displayDate, boolean indexable, int status,
		OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		JournalArticle journalArticle = fetchByR_NotC_LtD_I_ST_First(resourcePrimKey,
				classNameId, displayDate, indexable, status, orderByComparator);
	 ...
	 */
	@Override
	public JournalArticle fetchByR_NotC_LtD_I_ST_First(long resourcePrimKey,
		long classNameId, Date displayDate, boolean indexable, int status,
		OrderByComparator orderByComparator) throws SystemException {
		List<JournalArticle> list = findByR_NotC_LtD_I_ST(resourcePrimKey,
				classNameId, displayDate, indexable, status, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last journal article in the ordered set where resourcePrimKey = &#63; and classNameId &ne; &#63; and displayDate &lt; &#63; and indexable = &#63; and status = &#63;.
	 *
	 * @param resourcePrimKey the resource prim key
	 * @param classNameId the class name ID
	 * @param displayDate the display date
	 ...
	 */
	@Override
	public JournalArticle findByR_NotC_LtD_I_ST_Last(long resourcePrimKey,
		long classNameId, Date displayDate, boolean indexable, int status,
		OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		JournalArticle journalArticle = fetchByR_NotC_LtD_I_ST_Last(resourcePrimKey,
				classNameId, displayDate, indexable, status, orderByComparator);
	 ...
	 */
	@Override
	public JournalArticle fetchByR_NotC_LtD_I_ST_Last(long resourcePrimKey,
		long classNameId, Date displayDate, boolean indexable, int status,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByR_NotC_LtD_I_ST(resourcePrimKey, classNameId,
				displayDate, indexable, status);

		List<JournalArticle> list = findByR_NotC_LtD_I_ST(resourcePrimKey,
				classNameId, displayDate, indexable, status, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the journal articles before and after the current journal article in the ordered set where resourcePrimKey = &#63; and classNameId &ne; &#63; and displayDate &lt; &#63; and indexable = &#63; and status = &#63;.
	 *
	 * @param id the primary key of the current journal article
	 * @param resourcePrimKey the resource prim key
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public JournalArticle[] findByR_NotC_LtD_I_ST_PrevAndNext(long id,
		long resourcePrimKey, long classNameId, Date displayDate,
		...
		try {
			...
			array[0] = getByR_NotC_LtD_I_ST_PrevAndNext(session,
					journalArticle, resourcePrimKey, classNameId, displayDate,
					indexable, status, orderByComparator, true);

			array[1] = journalArticle;

			array[2] = getByR_NotC_LtD_I_ST_PrevAndNext(session,
					journalArticle, resourcePrimKey, classNameId, displayDate,
					indexable, status, orderByComparator, false);
	...
	protected JournalArticle getByR_NotC_LtD_I_ST_PrevAndNext(Session session,
		JournalArticle journalArticle, long resourcePrimKey, long classNameId,
		Date displayDate, boolean indexable, int status,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Returns all the journal articles where resourcePrimKey = &#63; and classNameId &ne; &#63; and displayDate &lt; &#63; and indexable = &#63; and status = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.journal.model.impl.JournalArticleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<JournalArticle> findByR_NotC_LtD_I_ST(long resourcePrimKey,
		long classNameId, Date displayDate, boolean indexable, int[] statuses)
		throws SystemException {
		return findByR_NotC_LtD_I_ST(resourcePrimKey, classNameId, displayDate,
			indexable, statuses, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the journal articles where resourcePrimKey = &#63; and classNameId &ne; &#63; and displayDate &lt; &#63; and indexable = &#63; and status = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.journal.model.impl.JournalArticleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<JournalArticle> findByR_NotC_LtD_I_ST(long resourcePrimKey,
		...
		int start, int end) throws SystemException {
		return findByR_NotC_LtD_I_ST(resourcePrimKey, classNameId, displayDate,
			indexable, statuses, start, end, null);
	}

	/**
	 * Returns an ordered range of all the journal articles where resourcePrimKey = &#63; and classNameId &ne; &#63; and displayDate &lt; &#63; and indexable = &#63; and status = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.journal.model.impl.JournalArticleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<JournalArticle> findByR_NotC_LtD_I_ST(long resourcePrimKey,
		...
		throws SystemException {
		if ((statuses != null) && (statuses.length == 1)) {
			return findByR_NotC_LtD_I_ST(resourcePrimKey, classNameId,
				displayDate, indexable, statuses[0], start, end,
				orderByComparator);
		}
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderArgs = new Object[] {
					resourcePrimKey, classNameId, displayDate, indexable,
		...
		List<JournalArticle> list = (List<JournalArticle>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_R_NOTC_LTD_I_ST,
				finderArgs, this);
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_R_NOTC_LTD_I_ST_RESOURCEPRIMKEY_5);
			...
			query.append(_FINDER_COLUMN_R_NOTC_LTD_I_ST_CLASSNAMEID_5);
			...
			if (displayDate == null) {
				query.append(_FINDER_COLUMN_R_NOTC_LTD_I_ST_DISPLAYDATE_4);
			}
			else {
				query.append(_FINDER_COLUMN_R_NOTC_LTD_I_ST_DISPLAYDATE_5);
			}
			...
			query.append(_FINDER_COLUMN_R_NOTC_LTD_I_ST_INDEXABLE_5);
			...
			if ((statuses == null) || (statuses.length > 0)) {
				...
				for (int i = 0; i < statuses.length; i++) {
					query.append(_FINDER_COLUMN_R_NOTC_LTD_I_ST_STATUS_5);
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_R_NOTC_LTD_I_ST,
					finderArgs, list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_R_NOTC_LTD_I_ST,
					finderArgs);
	...
	/**
	 * Removes all the journal articles where resourcePrimKey = &#63; and classNameId &ne; &#63; and displayDate &lt; &#63; and indexable = &#63; and status = &#63; from the database.
	 *
	 * @param resourcePrimKey the resource prim key
	 * @param classNameId the class name ID
	 * @param displayDate the display date
	 ...
	 */
	@Override
	public void removeByR_NotC_LtD_I_ST(long resourcePrimKey, long classNameId,
		Date displayDate, boolean indexable, int status)
		throws SystemException {
		for (JournalArticle journalArticle : findByR_NotC_LtD_I_ST(
				resourcePrimKey, classNameId, displayDate, indexable, status,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(journalArticle);
		}
	...
	/**
	 * Returns the number of journal articles where resourcePrimKey = &#63; and classNameId &ne; &#63; and displayDate &lt; &#63; and indexable = &#63; and status = &#63;.
	 *
	 * @param resourcePrimKey the resource prim key
	 * @param classNameId the class name ID
	 * @param displayDate the display date
	 ...
	 */
	@Override
	public int countByR_NotC_LtD_I_ST(long resourcePrimKey, long classNameId,
		Date displayDate, boolean indexable, int status)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_R_NOTC_LTD_I_ST;
	...
	/**
	 * Returns the number of journal articles where resourcePrimKey = &#63; and classNameId &ne; &#63; and displayDate &lt; &#63; and indexable = &#63; and status = any &#63;.
	 *
	 * @param resourcePrimKey the resource prim key
	 * @param classNameId the class name ID
	 * @param displayDate the display date
	...
	@Override
	public int countByR_NotC_LtD_I_ST(long resourcePrimKey, long classNameId,
		Date displayDate, boolean indexable, int[] statuses)
		throws SystemException {
		Object[] finderArgs = new Object[] {
				resourcePrimKey, classNameId, displayDate, indexable,
				StringUtil.merge(statuses)
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_R_NOTC_LTD_I_ST,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_R_NOTC_LTD_I_ST,
					finderArgs, count);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_R_NOTC_LTD_I_ST,
					finderArgs);
	...
	private static final String _FINDER_COLUMN_R_NOTC_LTD_I_ST_RESOURCEPRIMKEY_2 =
		"journalArticle.resourcePrimKey = ? AND ";
	private static final String _FINDER_COLUMN_R_NOTC_LTD_I_ST_RESOURCEPRIMKEY_5 =
		"(" +
		removeConjunction(_FINDER_COLUMN_R_NOTC_LTD_I_ST_RESOURCEPRIMKEY_2) +
		")";
	private static final String _FINDER_COLUMN_R_NOTC_LTD_I_ST_CLASSNAMEID_2 = "journalArticle.classNameId != ? AND ";
	private static final String _FINDER_COLUMN_R_NOTC_LTD_I_ST_CLASSNAMEID_5 = "(" +
		removeConjunction(_FINDER_COLUMN_R_NOTC_LTD_I_ST_CLASSNAMEID_2) + ")";
	private static final String _FINDER_COLUMN_R_NOTC_LTD_I_ST_DISPLAYDATE_1 = "journalArticle.displayDate < NULL AND ";
	private static final String _FINDER_COLUMN_R_NOTC_LTD_I_ST_DISPLAYDATE_2 = "journalArticle.displayDate < ? AND ";
	private static final String _FINDER_COLUMN_R_NOTC_LTD_I_ST_DISPLAYDATE_4 = "(" +
		removeConjunction(_FINDER_COLUMN_R_NOTC_LTD_I_ST_DISPLAYDATE_1) + ")";
	private static final String _FINDER_COLUMN_R_NOTC_LTD_I_ST_DISPLAYDATE_5 = "(" +
		removeConjunction(_FINDER_COLUMN_R_NOTC_LTD_I_ST_DISPLAYDATE_2) + ")";
	private static final String _FINDER_COLUMN_R_NOTC_LTD_I_ST_INDEXABLE_2 = "journalArticle.indexable = ? AND ";
	private static final String _FINDER_COLUMN_R_NOTC_LTD_I_ST_INDEXABLE_5 = "(" +
		removeConjunction(_FINDER_COLUMN_R_NOTC_LTD_I_ST_INDEXABLE_2) + ")";
	private static final String _FINDER_COLUMN_R_NOTC_LTD_I_ST_STATUS_2 = "journalArticle.status = ?";
	private static final String _FINDER_COLUMN_R_NOTC_LTD_I_ST_STATUS_5 = "(" +
		removeConjunction(_FINDER_COLUMN_R_NOTC_LTD_I_ST_STATUS_2) + ")";
