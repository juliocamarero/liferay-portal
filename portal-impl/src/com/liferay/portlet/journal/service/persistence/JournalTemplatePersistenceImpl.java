...
public class JournalTemplatePersistenceImpl extends BasePersistenceImpl<JournalTemplate>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_ = "journalTemplate.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_ = "journalTemplate.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_ = "(journalTemplate.uuid_ IS NULL OR journalTemplate.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1_ = "journalTemplate.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_ = "journalTemplate.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_ = "(journalTemplate.uuid_ IS NULL OR journalTemplate.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_ = "journalTemplate.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_ = "journalTemplate.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_ = "(journalTemplate.uuid_ IS NULL OR journalTemplate.uuid_ = ?) AND ";
