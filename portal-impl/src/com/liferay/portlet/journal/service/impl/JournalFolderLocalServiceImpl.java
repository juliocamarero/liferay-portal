...
public class JournalFolderLocalServiceImpl
	...
	@Override
	public List<DDMStructure> getFolderDDMStructures(
		...
		folderId = getStructurePrimaryFolderId(folderId);
	...
	public JournalFolder updateFolder(
		...
		List<Long> ddmStructureIds = getLongList(
			serviceContext, "ddmStructuresSearchContainerPrimaryKeys");
		boolean overrideDDMStructures = ParamUtil.getBoolean(
			serviceContext, "overrideDDMStructures");
	...
	public void updateFolderDDMStructures(
		...
		List<Long> originalDDMStructureIds = getStructureIds(
	...
	protected List<Long> getStructureIds(List<DDMStructure> structures) {
		List<Long> structureIds = new SortedArrayList<Long>();
	...
	protected long getStructurePrimaryFolderId(long folderId)
