...
public class JournalFeedStagedModelDataHandler
	...
	protected void doExportStagedModel(
		...
		Element feedElement =
			portletDataContext.getExportDataStagedModelElement(feed);
	...
	protected void doImportStagedModel(
		...
		for (Element templateElement : templateElements) {
			String templatePath = templateElement.attributeValue("path");
			...
			boolean renderTemplate = GetterUtil.getBoolean(
				templateElement.attributeValue("renderTemplate"));
