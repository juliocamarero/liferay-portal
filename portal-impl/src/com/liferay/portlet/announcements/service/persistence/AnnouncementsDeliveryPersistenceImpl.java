...
public class AnnouncementsDeliveryPersistenceImpl extends BasePersistenceImpl<AnnouncementsDelivery>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(AnnouncementsDeliveryModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !AnnouncementsDeliveryModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((announcementsDeliveryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(announcementsDeliveryModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(announcementsDeliveryModelImpl.getCompanyId())
					};
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AnnouncementsDelivery findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchDeliveryException, SystemException {
		List<AnnouncementsDelivery> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AnnouncementsDelivery findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchDeliveryException, SystemException {
		int count = countByCompanyId(companyId);

		List<AnnouncementsDelivery> list = findByCompanyId(companyId,
	...
	public AnnouncementsDelivery[] findByCompanyId_PrevAndNext(
		long deliveryId, long companyId, OrderByComparator orderByComparator)
		throws NoSuchDeliveryException, SystemException {
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session,
					announcementsDelivery, companyId, orderByComparator, true);

			array[1] = announcementsDelivery;

			array[2] = getByCompanyId_PrevAndNext(session,
					announcementsDelivery, companyId, orderByComparator, false);
	...
	public void removeByCompanyId(long companyId) throws SystemException {
		for (AnnouncementsDelivery announcementsDelivery : findByCompanyId(
				companyId)) {
