...
public class AnnouncementsEntryPersistenceImpl extends BasePersistenceImpl<AnnouncementsEntry>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(AnnouncementsEntryModelImpl.ENTITY_CACHE_ENABLED,
			...
			AnnouncementsEntryModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(AnnouncementsEntryModelImpl.ENTITY_CACHE_ENABLED,
			AnnouncementsEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AnnouncementsEntry> findByCompanyId(long companyId, int start,
		int end) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AnnouncementsEntry findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		List<AnnouncementsEntry> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AnnouncementsEntry findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		int count = countByCompanyId(companyId);

		List<AnnouncementsEntry> list = findByCompanyId(companyId, count - 1,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AnnouncementsEntry[] findByCompanyId_PrevAndNext(long entryId,
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, announcementsEntry,
					companyId, orderByComparator, true);

			array[1] = announcementsEntry;

			array[2] = getByCompanyId_PrevAndNext(session, announcementsEntry,
	...
	protected AnnouncementsEntry getByCompanyId_PrevAndNext(Session session,
	...
	public AnnouncementsEntry[] filterFindByCompanyId_PrevAndNext(
		long entryId, long companyId, OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled()) {
			return findByCompanyId_PrevAndNext(entryId, companyId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByCompanyId_PrevAndNext(session,
					announcementsEntry, companyId, orderByComparator, true);

			array[1] = announcementsEntry;

			array[2] = filterGetByCompanyId_PrevAndNext(session,
					announcementsEntry, companyId, orderByComparator, false);
	...
	public void removeByCompanyId(long companyId) throws SystemException {
		for (AnnouncementsEntry announcementsEntry : findByCompanyId(companyId)) {
			remove(announcementsEntry);
		}
	}
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "announcementsEntry.companyId = ?";
