...
public class DLFileVersionPersistenceImpl extends BasePersistenceImpl<DLFileVersion>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_ = "dlFileVersion.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_ = "dlFileVersion.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_ = "(dlFileVersion.uuid_ IS NULL OR dlFileVersion.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1_ = "dlFileVersion.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_ = "dlFileVersion.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_ = "(dlFileVersion.uuid_ IS NULL OR dlFileVersion.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_ = "dlFileVersion.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_ = "dlFileVersion.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_ = "(dlFileVersion.uuid_ IS NULL OR dlFileVersion.uuid_ = ?) AND ";
