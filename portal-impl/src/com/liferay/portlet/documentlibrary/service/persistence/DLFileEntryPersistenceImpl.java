...
public class DLFileEntryPersistenceImpl extends BasePersistenceImpl<DLFileEntry>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_ = "dlFileEntry.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_ = "dlFileEntry.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_ = "(dlFileEntry.uuid_ IS NULL OR dlFileEntry.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1_ = "dlFileEntry.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_ = "dlFileEntry.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_ = "(dlFileEntry.uuid_ IS NULL OR dlFileEntry.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_ = "dlFileEntry.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_ = "dlFileEntry.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_ = "(dlFileEntry.uuid_ IS NULL OR dlFileEntry.uuid_ = ?) AND ";
