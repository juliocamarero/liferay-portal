...
public class DLSyncPersistenceImpl extends BasePersistenceImpl<DLSync>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(DLSyncModelImpl.ENTITY_CACHE_ENABLED,
	...
	public DLSync updateImpl(
		...
		if (isNew || !DLSyncModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((dlSyncModelImpl.getColumnBitmask() &
				...
				args = new Object[] { Long.valueOf(dlSyncModelImpl.getCompanyId()) };
	...
	/**
	 * Returns all the d l syncs where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching d l syncs
	 * @throws SystemException if a system exception occurred
	 */
	public List<DLSync> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the d l syncs where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DLSync> findByCompanyId(long companyId, int start, int end)
		throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the d l syncs where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	/**
	 * Returns the first d l sync in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DLSync findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchSyncException, SystemException {
		List<DLSync> list = findByCompanyId(companyId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last d l sync in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DLSync findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchSyncException, SystemException {
		int count = countByCompanyId(companyId);

		List<DLSync> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the d l syncs before and after the current d l sync in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DLSync[] findByCompanyId_PrevAndNext(long syncId, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchSyncException, SystemException {
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, dlSync, companyId,
					orderByComparator, true);

			array[1] = dlSync;

			array[2] = getByCompanyId_PrevAndNext(session, dlSync, companyId,
	...
	protected DLSync getByCompanyId_PrevAndNext(Session session, DLSync dlSync,
	...
	/**
	 * Removes all the d l syncs where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (DLSync dlSync : findByCompanyId(companyId)) {
			remove(dlSync);
		}
	}
	...
	/**
	 * Returns the number of d l syncs where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "dlSync.companyId = ?";
