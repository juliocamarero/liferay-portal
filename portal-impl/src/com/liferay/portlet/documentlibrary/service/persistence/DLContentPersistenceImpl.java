...
public class DLContentPersistenceImpl extends BasePersistenceImpl<DLContent>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(DLContentModelImpl.ENTITY_CACHE_ENABLED,
	...
	/**
	 * Returns all the document library contents where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching document library contents
	 * @throws SystemException if a system exception occurred
	 */
	public List<DLContent> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the document library contents where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DLContent> findByCompanyId(long companyId, int start, int end)
		throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the document library contents where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	/**
	 * Returns the first document library content in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DLContent findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchContentException, SystemException {
		List<DLContent> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last document library content in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DLContent findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchContentException, SystemException {
		int count = countByCompanyId(companyId);

		List<DLContent> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the document library contents before and after the current document library content in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DLContent[] findByCompanyId_PrevAndNext(long contentId,
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, dlContent,
					companyId, orderByComparator, true);

			array[1] = dlContent;

			array[2] = getByCompanyId_PrevAndNext(session, dlContent,
	...
	protected DLContent getByCompanyId_PrevAndNext(Session session,
		DLContent dlContent, long companyId,
	...
	/**
	 * Removes all the document library contents where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (DLContent dlContent : findByCompanyId(companyId)) {
			remove(dlContent);
		}
	}
	...
	/**
	 * Returns the number of document library contents where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "dlContent.companyId = ?";
