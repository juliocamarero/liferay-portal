...
public class DDLRecordPersistenceImpl extends BasePersistenceImpl<DDLRecord>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_ = "ddlRecord.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_ = "ddlRecord.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_ = "(ddlRecord.uuid_ IS NULL OR ddlRecord.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1_ = "ddlRecord.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_ = "ddlRecord.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_ = "(ddlRecord.uuid_ IS NULL OR ddlRecord.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_ = "ddlRecord.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_ = "ddlRecord.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_ = "(ddlRecord.uuid_ IS NULL OR ddlRecord.uuid_ = ?) AND ";
