 ...
 */
public class TempDLFormFieldValueTransformer
	...
	protected FileEntry addFileEntry(FileEntry tempFileEntry)
		...
		String fileName = formatFileName(tempFileEntry.getFileName());
	...
	protected String formatFileName(String fileName) {
		...
		int pos = fileName.lastIndexOf(EditFileEntryAction.TEMP_RANDOM_SUFFIX);

		if (pos != -1) {
			fileName = fileName.substring(0, pos);

			if (Validator.isNotNull(extension)) {
				fileName = fileName + StringPool.PERIOD + extension;
			}
		}
