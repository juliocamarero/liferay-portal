...
public class MDRRuleGroupInstancePersistenceImpl extends BasePersistenceImpl<MDRRuleGroupInstance>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_ = "mdrRuleGroupInstance.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_ = "mdrRuleGroupInstance.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_ = "(mdrRuleGroupInstance.uuid_ IS NULL OR mdrRuleGroupInstance.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1_ = "mdrRuleGroupInstance.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_ = "mdrRuleGroupInstance.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_ = "(mdrRuleGroupInstance.uuid_ IS NULL OR mdrRuleGroupInstance.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_ = "mdrRuleGroupInstance.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_ = "mdrRuleGroupInstance.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_ = "(mdrRuleGroupInstance.uuid_ IS NULL OR mdrRuleGroupInstance.uuid_ = ?) AND ";
