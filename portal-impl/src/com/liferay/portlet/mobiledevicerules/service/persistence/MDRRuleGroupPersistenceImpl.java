...
public class MDRRuleGroupPersistenceImpl extends BasePersistenceImpl<MDRRuleGroup>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_ = "mdrRuleGroup.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_ = "mdrRuleGroup.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_ = "(mdrRuleGroup.uuid_ IS NULL OR mdrRuleGroup.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1_ = "mdrRuleGroup.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_ = "mdrRuleGroup.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_ = "(mdrRuleGroup.uuid_ IS NULL OR mdrRuleGroup.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_ = "mdrRuleGroup.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_ = "mdrRuleGroup.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_ = "(mdrRuleGroup.uuid_ IS NULL OR mdrRuleGroup.uuid_ = ?) AND ";
