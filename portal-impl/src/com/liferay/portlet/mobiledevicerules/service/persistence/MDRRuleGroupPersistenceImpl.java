...
public class MDRRuleGroupPersistenceImpl extends BasePersistenceImpl<MDRRuleGroup>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(MDRRuleGroupModelImpl.ENTITY_CACHE_ENABLED,
			...
			MDRRuleGroupModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(MDRRuleGroupModelImpl.ENTITY_CACHE_ENABLED,
			MDRRuleGroupModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	/**
	 * Returns all the m d r rule groups where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching m d r rule groups
	 * @throws SystemException if a system exception occurred
	 */
	public List<MDRRuleGroup> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the m d r rule groups where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<MDRRuleGroup> findByCompanyId(long companyId, int start, int end)
		throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the m d r rule groups where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<MDRRuleGroup> findByCompanyId(long companyId, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (MDRRuleGroup mdrRuleGroup : list) {
				if ((companyId != mdrRuleGroup.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first m d r rule group in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MDRRuleGroup findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchRuleGroupException, SystemException {
		List<MDRRuleGroup> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last m d r rule group in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MDRRuleGroup findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchRuleGroupException, SystemException {
		int count = countByCompanyId(companyId);

		List<MDRRuleGroup> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the m d r rule groups before and after the current m d r rule group in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MDRRuleGroup[] findByCompanyId_PrevAndNext(long ruleGroupId,
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, mdrRuleGroup,
					companyId, orderByComparator, true);

			array[1] = mdrRuleGroup;

			array[2] = getByCompanyId_PrevAndNext(session, mdrRuleGroup,
					companyId, orderByComparator, false);
	...
	protected MDRRuleGroup getByCompanyId_PrevAndNext(Session session,
		MDRRuleGroup mdrRuleGroup, long companyId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the m d r rule groups where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (MDRRuleGroup mdrRuleGroup : findByCompanyId(companyId)) {
			remove(mdrRuleGroup);
		}
	}
	...
	/**
	 * Returns the number of m d r rule groups where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the number of matching m d r rule groups
	 * @throws SystemException if a system exception occurred
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "mdrRuleGroup.companyId = ?";
