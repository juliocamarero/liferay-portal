...
public class MDRRulePersistenceImpl extends BasePersistenceImpl<MDRRule>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_ = "mdrRule.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_ = "mdrRule.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_ = "(mdrRule.uuid_ IS NULL OR mdrRule.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1_ = "mdrRule.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_ = "mdrRule.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_ = "(mdrRule.uuid_ IS NULL OR mdrRule.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_ = "mdrRule.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_ = "mdrRule.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_ = "(mdrRule.uuid_ IS NULL OR mdrRule.uuid_ = ?) AND ";
