...
public class MDRRulePersistenceImpl extends BasePersistenceImpl<MDRRule>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(MDRRuleModelImpl.ENTITY_CACHE_ENABLED,
			...
			MDRRuleModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(MDRRuleModelImpl.ENTITY_CACHE_ENABLED,
			MDRRuleModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<MDRRule> findByCompanyId(long companyId)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<MDRRule> findByCompanyId(long companyId, int start, int end)
		throws SystemException {
	...
	public List<MDRRule> findByCompanyId(long companyId, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (MDRRule mdrRule : list) {
				if ((companyId != mdrRule.getCompanyId())) {
					list = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MDRRule findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchRuleException, SystemException {
		List<MDRRule> list = findByCompanyId(companyId, 0, 1, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MDRRule findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchRuleException, SystemException {
		int count = countByCompanyId(companyId);

		List<MDRRule> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MDRRule[] findByCompanyId_PrevAndNext(long ruleId, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchRuleException, SystemException {
		MDRRule mdrRule = findByPrimaryKey(ruleId);
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, mdrRule, companyId,
					orderByComparator, true);

			array[1] = mdrRule;

			array[2] = getByCompanyId_PrevAndNext(session, mdrRule, companyId,
					orderByComparator, false);
	...
	protected MDRRule getByCompanyId_PrevAndNext(Session session,
		MDRRule mdrRule, long companyId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByCompanyId(long companyId) throws SystemException {
		for (MDRRule mdrRule : findByCompanyId(companyId)) {
			remove(mdrRule);
		}
	}
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "mdrRule.companyId = ?";
