...
public class ShoppingCartPersistenceImpl extends BasePersistenceImpl<ShoppingCart>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(ShoppingCartModelImpl.ENTITY_CACHE_ENABLED,
			...
			ShoppingCartModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(ShoppingCartModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !ShoppingCartModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((shoppingCartModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(shoppingCartModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(shoppingCartModelImpl.getCompanyId())
					};
	...
	/**
	 * Returns all the shopping carts where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching shopping carts
	 * @throws SystemException if a system exception occurred
	 */
	public List<ShoppingCart> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the shopping carts where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ShoppingCart> findByCompanyId(long companyId, int start, int end)
		throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the shopping carts where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ShoppingCart> findByCompanyId(long companyId, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ShoppingCart shoppingCart : list) {
				if ((companyId != shoppingCart.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first shopping cart in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ShoppingCart findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchCartException, SystemException {
		List<ShoppingCart> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last shopping cart in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ShoppingCart findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchCartException, SystemException {
		int count = countByCompanyId(companyId);

		List<ShoppingCart> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the shopping carts before and after the current shopping cart in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ShoppingCart[] findByCompanyId_PrevAndNext(long cartId,
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, shoppingCart,
					companyId, orderByComparator, true);

			array[1] = shoppingCart;

			array[2] = getByCompanyId_PrevAndNext(session, shoppingCart,
	...
	protected ShoppingCart getByCompanyId_PrevAndNext(Session session,
		ShoppingCart shoppingCart, long companyId,
	...
	/**
	 * Removes all the shopping carts where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (ShoppingCart shoppingCart : findByCompanyId(companyId)) {
			remove(shoppingCart);
		}
	}
	...
	/**
	 * Returns the number of shopping carts where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "shoppingCart.companyId = ?";
