...
public class ShoppingOrderPersistenceImpl extends BasePersistenceImpl<ShoppingOrder>
		...
		if (isNew || !ShoppingOrderModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((shoppingOrderModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(shoppingOrderModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(shoppingOrderModelImpl.getCompanyId())
					};
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ShoppingOrder[] findByCompanyId_PrevAndNext(long orderId,
