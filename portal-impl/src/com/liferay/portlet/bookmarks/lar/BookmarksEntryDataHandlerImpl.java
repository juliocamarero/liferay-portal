...
import com.liferay.portal.kernel.lar.ImportExportPathUtil;
...
public class BookmarksEntryDataHandlerImpl
	...
	protected void doExport(
		...
		String path = ImportExportPathUtil.getEntityPath(entry);

		if (!portletDataContext.isPathNotProcessed(path) ||
			!portletDataContext.isWithinDateRange(entry.getModifiedDate())) {
	...
	protected void doImportData(
		...
		if ((folderId != BookmarksFolderConstants.DEFAULT_PARENT_FOLDER_ID) &&
			...
			String parentFolderPath = ImportExportPathUtil.getEntityPath(
				folderId, BookmarksFolder.class, portletDataContext);
