...
public class BookmarksEntryPersistenceImpl extends BasePersistenceImpl<BookmarksEntry>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_ = "bookmarksEntry.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_ = "bookmarksEntry.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_ = "(bookmarksEntry.uuid_ IS NULL OR bookmarksEntry.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1_ = "bookmarksEntry.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_ = "bookmarksEntry.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_ = "(bookmarksEntry.uuid_ IS NULL OR bookmarksEntry.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_ = "bookmarksEntry.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_ = "bookmarksEntry.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_ = "(bookmarksEntry.uuid_ IS NULL OR bookmarksEntry.uuid_ = ?) AND ";
