...
public class BookmarksFolderPersistenceImpl extends BasePersistenceImpl<BookmarksFolder>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_ = "bookmarksFolder.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_ = "bookmarksFolder.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_ = "(bookmarksFolder.uuid_ IS NULL OR bookmarksFolder.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1_ = "bookmarksFolder.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_ = "bookmarksFolder.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_ = "(bookmarksFolder.uuid_ IS NULL OR bookmarksFolder.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_ = "bookmarksFolder.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_ = "bookmarksFolder.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_ = "(bookmarksFolder.uuid_ IS NULL OR bookmarksFolder.uuid_ = ?) AND ";
