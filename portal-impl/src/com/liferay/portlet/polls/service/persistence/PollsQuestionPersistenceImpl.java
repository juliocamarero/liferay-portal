...
public class PollsQuestionPersistenceImpl extends BasePersistenceImpl<PollsQuestion>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_ = "pollsQuestion.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_ = "pollsQuestion.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_ = "(pollsQuestion.uuid_ IS NULL OR pollsQuestion.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1_ = "pollsQuestion.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_ = "pollsQuestion.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_ = "(pollsQuestion.uuid_ IS NULL OR pollsQuestion.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_ = "pollsQuestion.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_ = "pollsQuestion.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_ = "(pollsQuestion.uuid_ IS NULL OR pollsQuestion.uuid_ = ?) AND ";
