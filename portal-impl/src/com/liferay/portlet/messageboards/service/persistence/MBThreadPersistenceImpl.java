...
public class MBThreadPersistenceImpl extends BasePersistenceImpl<MBThread>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(MBThreadModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !MBThreadModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((mbThreadModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(mbThreadModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(mbThreadModelImpl.getCompanyId())
					};
	...
	/**
	 * Returns all the message boards threads where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching message boards threads
	 * @throws SystemException if a system exception occurred
	 */
	public List<MBThread> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the message boards threads where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<MBThread> findByCompanyId(long companyId, int start, int end)
		throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the message boards threads where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<MBThread> findByCompanyId(long companyId, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (MBThread mbThread : list) {
				if ((companyId != mbThread.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first message boards thread in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MBThread findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchThreadException, SystemException {
		List<MBThread> list = findByCompanyId(companyId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last message boards thread in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MBThread findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchThreadException, SystemException {
		int count = countByCompanyId(companyId);

		List<MBThread> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the message boards threads before and after the current message boards thread in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MBThread[] findByCompanyId_PrevAndNext(long threadId,
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, mbThread, companyId,
					orderByComparator, true);

			array[1] = mbThread;

			array[2] = getByCompanyId_PrevAndNext(session, mbThread, companyId,
	...
	protected MBThread getByCompanyId_PrevAndNext(Session session,
		MBThread mbThread, long companyId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the message boards threads where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (MBThread mbThread : findByCompanyId(companyId)) {
			remove(mbThread);
		}
	}
	...
	/**
	 * Returns the number of message boards threads where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "mbThread.companyId = ?";
