...
public class MBBanPersistenceImpl extends BasePersistenceImpl<MBBan>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(MBBanModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !MBBanModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((mbBanModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(mbBanModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] { Long.valueOf(mbBanModelImpl.getCompanyId()) };
	...
	/**
	 * Returns all the message boards bans where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching message boards bans
	 * @throws SystemException if a system exception occurred
	 */
	public List<MBBan> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the message boards bans where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<MBBan> findByCompanyId(long companyId, int start, int end)
		throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the message boards bans where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<MBBan> findByCompanyId(long companyId, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (MBBan mbBan : list) {
				if ((companyId != mbBan.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first message boards ban in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MBBan findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchBanException, SystemException {
		List<MBBan> list = findByCompanyId(companyId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last message boards ban in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MBBan findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchBanException, SystemException {
		int count = countByCompanyId(companyId);

		List<MBBan> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the message boards bans before and after the current message boards ban in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MBBan[] findByCompanyId_PrevAndNext(long banId, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchBanException, SystemException {
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, mbBan, companyId,
					orderByComparator, true);

			array[1] = mbBan;

			array[2] = getByCompanyId_PrevAndNext(session, mbBan, companyId,
	...
	protected MBBan getByCompanyId_PrevAndNext(Session session, MBBan mbBan,
	...
	/**
	 * Removes all the message boards bans where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (MBBan mbBan : findByCompanyId(companyId)) {
			remove(mbBan);
		}
	}
	...
	/**
	 * Returns the number of message boards bans where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "mbBan.companyId = ?";
