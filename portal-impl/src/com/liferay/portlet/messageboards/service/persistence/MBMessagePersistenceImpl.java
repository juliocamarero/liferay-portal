...
public class MBMessagePersistenceImpl extends BasePersistenceImpl<MBMessage>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_ = "mbMessage.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_ = "mbMessage.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_ = "(mbMessage.uuid_ IS NULL OR mbMessage.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1_ = "mbMessage.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_ = "mbMessage.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_ = "(mbMessage.uuid_ IS NULL OR mbMessage.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_ = "mbMessage.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_ = "mbMessage.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_ = "(mbMessage.uuid_ IS NULL OR mbMessage.uuid_ = ?) AND ";
