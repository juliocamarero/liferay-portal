...
public class SocialActivityAchievementPersistenceImpl
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(SocialActivityAchievementModelImpl.ENTITY_CACHE_ENABLED,
			...
			SocialActivityAchievementModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(SocialActivityAchievementModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivityAchievementModelImpl.FINDER_CACHE_ENABLED,
		...
		if (isNew ||
			...
			if ((socialActivityAchievementModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(socialActivityAchievementModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(socialActivityAchievementModelImpl.getCompanyId())
					};
	...
	/**
	 * Returns all the social activity achievements where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching social activity achievements
	 * @throws SystemException if a system exception occurred
	 */
	public List<SocialActivityAchievement> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the social activity achievements where companyId = &#63;.
	 *
	 * <p>
	...
	/**
	 * Returns an ordered range of all the social activity achievements where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<SocialActivityAchievement> findByCompanyId(long companyId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (SocialActivityAchievement socialActivityAchievement : list) {
				if ((companyId != socialActivityAchievement.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first social activity achievement in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityAchievement findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchActivityAchievementException, SystemException {
		List<SocialActivityAchievement> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last social activity achievement in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityAchievement findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchActivityAchievementException, SystemException {
		int count = countByCompanyId(companyId);

		List<SocialActivityAchievement> list = findByCompanyId(companyId,
	...
	/**
	 * Returns the social activity achievements before and after the current social activity achievement in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityAchievement[] findByCompanyId_PrevAndNext(
		long activityAchievementId, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchActivityAchievementException, SystemException {
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session,
					socialActivityAchievement, companyId, orderByComparator,
					true);
	...
	protected SocialActivityAchievement getByCompanyId_PrevAndNext(
	...
	/**
	 * Removes all the social activity achievements where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (SocialActivityAchievement socialActivityAchievement : findByCompanyId(
				companyId)) {
	...
	/**
	 * Returns the number of social activity achievements where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "socialActivityAchievement.companyId = ?";
