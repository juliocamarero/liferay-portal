...
public class SocialActivitySettingPersistenceImpl extends BasePersistenceImpl<SocialActivitySetting>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(SocialActivitySettingModelImpl.ENTITY_CACHE_ENABLED,
			...
			SocialActivitySettingModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(SocialActivitySettingModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !SocialActivitySettingModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((socialActivitySettingModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(socialActivitySettingModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(socialActivitySettingModelImpl.getCompanyId())
					};
	...
	/**
	 * Returns all the social activity settings where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching social activity settings
	 * @throws SystemException if a system exception occurred
	 */
	public List<SocialActivitySetting> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the social activity settings where companyId = &#63;.
	 *
	 * <p>
	...
	/**
	 * Returns an ordered range of all the social activity settings where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<SocialActivitySetting> findByCompanyId(long companyId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (SocialActivitySetting socialActivitySetting : list) {
				if ((companyId != socialActivitySetting.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first social activity setting in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySetting findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchActivitySettingException, SystemException {
		List<SocialActivitySetting> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last social activity setting in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySetting findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchActivitySettingException, SystemException {
		int count = countByCompanyId(companyId);

		List<SocialActivitySetting> list = findByCompanyId(companyId,
	...
	/**
	 * Returns the social activity settings before and after the current social activity setting in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySetting[] findByCompanyId_PrevAndNext(
		long activitySettingId, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchActivitySettingException, SystemException {
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session,
					socialActivitySetting, companyId, orderByComparator, true);

			array[1] = socialActivitySetting;

			array[2] = getByCompanyId_PrevAndNext(session,
					socialActivitySetting, companyId, orderByComparator, false);
	...
	protected SocialActivitySetting getByCompanyId_PrevAndNext(
	...
	/**
	 * Removes all the social activity settings where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (SocialActivitySetting socialActivitySetting : findByCompanyId(
				companyId)) {
	...
	/**
	 * Returns the number of social activity settings where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "socialActivitySetting.companyId = ?";
