...
public class SocialActivityLimitPersistenceImpl extends BasePersistenceImpl<SocialActivityLimit>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(SocialActivityLimitModelImpl.ENTITY_CACHE_ENABLED,
			...
			SocialActivityLimitModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(SocialActivityLimitModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !SocialActivityLimitModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((socialActivityLimitModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(socialActivityLimitModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(socialActivityLimitModelImpl.getCompanyId())
					};
	...
	/**
	 * Returns all the social activity limits where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching social activity limits
	 * @throws SystemException if a system exception occurred
	 */
	public List<SocialActivityLimit> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the social activity limits where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SocialActivityLimit> findByCompanyId(long companyId, int start,
		int end) throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the social activity limits where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<SocialActivityLimit> findByCompanyId(long companyId, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (SocialActivityLimit socialActivityLimit : list) {
				if ((companyId != socialActivityLimit.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first social activity limit in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityLimit findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchActivityLimitException, SystemException {
		List<SocialActivityLimit> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last social activity limit in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityLimit findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchActivityLimitException, SystemException {
		int count = countByCompanyId(companyId);

		List<SocialActivityLimit> list = findByCompanyId(companyId, count - 1,
	...
	/**
	 * Returns the social activity limits before and after the current social activity limit in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityLimit[] findByCompanyId_PrevAndNext(
		long activityLimitId, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchActivityLimitException, SystemException {
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, socialActivityLimit,
					companyId, orderByComparator, true);

			array[1] = socialActivityLimit;

			array[2] = getByCompanyId_PrevAndNext(session, socialActivityLimit,
	...
	protected SocialActivityLimit getByCompanyId_PrevAndNext(Session session,
	...
	/**
	 * Removes all the social activity limits where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (SocialActivityLimit socialActivityLimit : findByCompanyId(
				companyId)) {
	...
	/**
	 * Returns the number of social activity limits where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "socialActivityLimit.companyId = ?";
