...
public class WikiPagePersistenceImpl extends BasePersistenceImpl<WikiPage>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_ = "wikiPage.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_ = "wikiPage.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_ = "(wikiPage.uuid_ IS NULL OR wikiPage.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1_ = "wikiPage.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_ = "wikiPage.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_ = "(wikiPage.uuid_ IS NULL OR wikiPage.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_ = "wikiPage.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_ = "wikiPage.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_ = "(wikiPage.uuid_ IS NULL OR wikiPage.uuid_ = ?) AND ";
