...
public class WikiNodePersistenceImpl extends BasePersistenceImpl<WikiNode>
	...
	public void removeByG_S(long groupId, int status) throws SystemException {
		for (WikiNode wikiNode : findByG_S(groupId, status)) {
			remove(wikiNode);
		}
	}
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_ = "wikiNode.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_ = "wikiNode.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_ = "(wikiNode.uuid_ IS NULL OR wikiNode.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1_ = "wikiNode.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_ = "wikiNode.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_ = "(wikiNode.uuid_ IS NULL OR wikiNode.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_ = "wikiNode.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_ = "wikiNode.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_ = "(wikiNode.uuid_ IS NULL OR wikiNode.uuid_ = ?) AND ";
