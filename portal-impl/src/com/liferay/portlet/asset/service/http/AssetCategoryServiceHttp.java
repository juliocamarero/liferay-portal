...
public class AssetCategoryServiceHttp {
	...
	public static com.liferay.portlet.asset.model.AssetCategoryDisplay getVocabularyCategoriesDisplayByTitle(
		...
		try {
			MethodKey methodKey = new MethodKey(AssetCategoryServiceUtil.class,
					"getVocabularyCategoriesDisplayByTitle",
					_getVocabularyCategoriesDisplayByTitleParameterTypes19);
	...
	public static com.liferay.portlet.asset.model.AssetCategoryDisplay getVocabularyCategoriesDisplayByTitle(
		...
		try {
			MethodKey methodKey = new MethodKey(AssetCategoryServiceUtil.class,
					"getVocabularyCategoriesDisplayByTitle",
					_getVocabularyCategoriesDisplayByTitleParameterTypes20);
	...
	public static java.lang.String getCategoryPath(
		...
		try {
			MethodKey methodKey = new MethodKey(AssetCategoryServiceUtil.class,
					"getCategoryPath", _getCategoryPathParameterTypes30);
	...
	private static final Class<?>[] _getVocabularyCategoriesDisplayByTitleParameterTypes19 =
		new Class[] {
			long.class, java.lang.String.class, long.class, int.class, int.class
		};
	private static final Class<?>[] _getVocabularyCategoriesDisplayByTitleParameterTypes20 =
		new Class[] {
			long[].class, java.lang.String.class, long[].class, int.class,
			int.class
		};
	...
	private static final Class<?>[] _getCategoryPathParameterTypes30 = new Class[] {
			long.class
		};
}