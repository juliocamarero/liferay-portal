...
public class AssetBookmarkServiceSoap {
	public static com.liferay.portlet.asset.model.AssetBookmarkSoap addAssetBookmark(
		...
		try {
			com.liferay.portlet.asset.model.AssetBookmark returnValue = AssetBookmarkServiceUtil.addAssetBookmark(groupId,
	...
	public static boolean isFavorite(long userId, java.lang.String className,
		long classPK) throws RemoteException {
		try {
			boolean returnValue = AssetBookmarkServiceUtil.isFavorite(userId,
					className, classPK);
