...
public class AssetLinkPersistenceImpl extends BasePersistenceImpl<AssetLink>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(AssetLinkModelImpl.ENTITY_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(AssetLinkModelImpl.ENTITY_CACHE_ENABLED,
			...
			AssetLinkModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(AssetLinkModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !AssetLinkModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((assetLinkModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(assetLinkModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(assetLinkModelImpl.getCompanyId())
					};
	...
	/**
	 * Returns all the asset links where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching asset links
	 * @throws SystemException if a system exception occurred
	 */
	public List<AssetLink> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the asset links where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AssetLink> findByCompanyId(long companyId, int start, int end)
		throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the asset links where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<AssetLink> findByCompanyId(long companyId, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (AssetLink assetLink : list) {
				if ((companyId != assetLink.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first asset link in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AssetLink findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchLinkException, SystemException {
		List<AssetLink> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last asset link in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AssetLink findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchLinkException, SystemException {
		int count = countByCompanyId(companyId);

		List<AssetLink> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the asset links before and after the current asset link in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AssetLink[] findByCompanyId_PrevAndNext(long linkId, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchLinkException, SystemException {
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, assetLink,
					companyId, orderByComparator, true);

			array[1] = assetLink;

			array[2] = getByCompanyId_PrevAndNext(session, assetLink,
	...
	protected AssetLink getByCompanyId_PrevAndNext(Session session,
		AssetLink assetLink, long companyId,
	...
	/**
	 * Removes all the asset links where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (AssetLink assetLink : findByCompanyId(companyId)) {
			remove(assetLink);
		}
	}
	...
	/**
	 * Returns the number of asset links where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "assetLink.companyId = ?";
