...
public class AssetVocabularyPersistenceImpl extends BasePersistenceImpl<AssetVocabulary>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_ = "assetVocabulary.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_ = "assetVocabulary.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_ = "(assetVocabulary.uuid_ IS NULL OR assetVocabulary.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1_ = "assetVocabulary.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_ = "assetVocabulary.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_ = "(assetVocabulary.uuid_ IS NULL OR assetVocabulary.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_ = "assetVocabulary.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_ = "assetVocabulary.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_ = "(assetVocabulary.uuid_ IS NULL OR assetVocabulary.uuid_ = ?) AND ";
