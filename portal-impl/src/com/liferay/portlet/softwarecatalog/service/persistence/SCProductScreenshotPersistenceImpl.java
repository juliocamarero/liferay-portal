...
public class SCProductScreenshotPersistenceImpl extends BasePersistenceImpl<SCProductScreenshot>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(SCProductScreenshotModelImpl.ENTITY_CACHE_ENABLED,
			...
			SCProductScreenshotModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(SCProductScreenshotModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !SCProductScreenshotModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((scProductScreenshotModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(scProductScreenshotModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(scProductScreenshotModelImpl.getCompanyId())
					};
	...
	/**
	 * Returns all the s c product screenshots where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching s c product screenshots
	 * @throws SystemException if a system exception occurred
	 */
	public List<SCProductScreenshot> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the s c product screenshots where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SCProductScreenshot> findByCompanyId(long companyId, int start,
		int end) throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the s c product screenshots where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<SCProductScreenshot> findByCompanyId(long companyId, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (SCProductScreenshot scProductScreenshot : list) {
				if ((companyId != scProductScreenshot.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first s c product screenshot in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SCProductScreenshot findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchProductScreenshotException, SystemException {
		List<SCProductScreenshot> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last s c product screenshot in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SCProductScreenshot findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchProductScreenshotException, SystemException {
		int count = countByCompanyId(companyId);

		List<SCProductScreenshot> list = findByCompanyId(companyId, count - 1,
	...
	/**
	 * Returns the s c product screenshots before and after the current s c product screenshot in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SCProductScreenshot[] findByCompanyId_PrevAndNext(
		long productScreenshotId, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchProductScreenshotException, SystemException {
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, scProductScreenshot,
					companyId, orderByComparator, true);

			array[1] = scProductScreenshot;

			array[2] = getByCompanyId_PrevAndNext(session, scProductScreenshot,
	...
	protected SCProductScreenshot getByCompanyId_PrevAndNext(Session session,
		SCProductScreenshot scProductScreenshot, long companyId,
	...
	/**
	 * Removes all the s c product screenshots where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (SCProductScreenshot scProductScreenshot : findByCompanyId(
				companyId)) {
	...
	/**
	 * Returns the number of s c product screenshots where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "scProductScreenshot.companyId = ?";
