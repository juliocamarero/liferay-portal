...
public class PortalServiceHttp {
	...
	public static void testHibernateFirstLevelCacheAutoSyncOnTxCreation(
		...
		try {
			MethodKey methodKey = new MethodKey(PortalServiceUtil.class,
					"testHibernateFirstLevelCacheAutoSyncOnTxCreation",
					_testHibernateFirstLevelCacheAutoSyncOnTxCreationParameterTypes12);
	...
	private static final Class<?>[] _testHibernateFirstLevelCacheAutoSyncOnTxCreationParameterTypes12 =
		new Class[] {  };
}