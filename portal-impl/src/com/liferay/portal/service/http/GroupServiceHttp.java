...
public class GroupServiceHttp {
	...
	public static void checkRemoteStaging(HttpPrincipal httpPrincipal,
		long groupId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class,
					"checkRemoteStaging", _checkRemoteStagingParameterTypes4);
	...
	private static final Class<?>[] _checkRemoteStagingParameterTypes4 = new Class[] {
			long.class
		};
