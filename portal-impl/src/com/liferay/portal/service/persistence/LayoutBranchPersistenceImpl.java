...
public class LayoutBranchPersistenceImpl extends BasePersistenceImpl<LayoutBranch>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(LayoutBranchModelImpl.ENTITY_CACHE_ENABLED,
			...
			LayoutBranchModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(LayoutBranchModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !LayoutBranchModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((layoutBranchModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(layoutBranchModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(layoutBranchModelImpl.getCompanyId())
					};
	...
	/**
	 * Returns all the layout branchs where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching layout branchs
	 * @throws SystemException if a system exception occurred
	 */
	public List<LayoutBranch> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the layout branchs where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<LayoutBranch> findByCompanyId(long companyId, int start, int end)
		throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the layout branchs where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<LayoutBranch> findByCompanyId(long companyId, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (LayoutBranch layoutBranch : list) {
				if ((companyId != layoutBranch.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first layout branch in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LayoutBranch findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchLayoutBranchException, SystemException {
		List<LayoutBranch> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last layout branch in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LayoutBranch findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchLayoutBranchException, SystemException {
		int count = countByCompanyId(companyId);

		List<LayoutBranch> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the layout branchs before and after the current layout branch in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LayoutBranch[] findByCompanyId_PrevAndNext(long LayoutBranchId,
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, layoutBranch,
					companyId, orderByComparator, true);

			array[1] = layoutBranch;

			array[2] = getByCompanyId_PrevAndNext(session, layoutBranch,
	...
	protected LayoutBranch getByCompanyId_PrevAndNext(Session session,
		LayoutBranch layoutBranch, long companyId,
	...
	/**
	 * Removes all the layout branchs where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (LayoutBranch layoutBranch : findByCompanyId(companyId)) {
			remove(layoutBranch);
		}
	}
	...
	/**
	 * Returns the number of layout branchs where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "layoutBranch.companyId = ?";
