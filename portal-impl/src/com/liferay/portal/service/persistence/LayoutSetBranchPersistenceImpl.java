...
public class LayoutSetBranchPersistenceImpl extends BasePersistenceImpl<LayoutSetBranch>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(LayoutSetBranchModelImpl.ENTITY_CACHE_ENABLED,
			...
			LayoutSetBranchModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(LayoutSetBranchModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !LayoutSetBranchModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((layoutSetBranchModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(layoutSetBranchModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(layoutSetBranchModelImpl.getCompanyId())
					};
	...
	/**
	 * Returns all the layout set branchs where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching layout set branchs
	 * @throws SystemException if a system exception occurred
	 */
	public List<LayoutSetBranch> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the layout set branchs where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<LayoutSetBranch> findByCompanyId(long companyId, int start,
		int end) throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the layout set branchs where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<LayoutSetBranch> findByCompanyId(long companyId, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (LayoutSetBranch layoutSetBranch : list) {
				if ((companyId != layoutSetBranch.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first layout set branch in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LayoutSetBranch findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchLayoutSetBranchException, SystemException {
		List<LayoutSetBranch> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last layout set branch in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LayoutSetBranch findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchLayoutSetBranchException, SystemException {
		int count = countByCompanyId(companyId);

		List<LayoutSetBranch> list = findByCompanyId(companyId, count - 1,
	...
	/**
	 * Returns the layout set branchs before and after the current layout set branch in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LayoutSetBranch[] findByCompanyId_PrevAndNext(
		long layoutSetBranchId, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchLayoutSetBranchException, SystemException {
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, layoutSetBranch,
					companyId, orderByComparator, true);

			array[1] = layoutSetBranch;

			array[2] = getByCompanyId_PrevAndNext(session, layoutSetBranch,
	...
	protected LayoutSetBranch getByCompanyId_PrevAndNext(Session session,
		LayoutSetBranch layoutSetBranch, long companyId,
	...
	/**
	 * Removes all the layout set branchs where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (LayoutSetBranch layoutSetBranch : findByCompanyId(companyId)) {
	...
	/**
	 * Returns the number of layout set branchs where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "layoutSetBranch.companyId = ?";
