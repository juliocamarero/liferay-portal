...
public class MembershipRequestPersistenceImpl extends BasePersistenceImpl<MembershipRequest>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(MembershipRequestModelImpl.ENTITY_CACHE_ENABLED,
			...
			MembershipRequestModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(MembershipRequestModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !MembershipRequestModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((membershipRequestModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(membershipRequestModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(membershipRequestModelImpl.getCompanyId())
					};
	...
	/**
	 * Returns all the membership requests where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching membership requests
	 * @throws SystemException if a system exception occurred
	 */
	public List<MembershipRequest> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the membership requests where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<MembershipRequest> findByCompanyId(long companyId, int start,
		int end) throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the membership requests where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<MembershipRequest> findByCompanyId(long companyId, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (MembershipRequest membershipRequest : list) {
				if ((companyId != membershipRequest.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first membership request in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MembershipRequest findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchMembershipRequestException, SystemException {
		List<MembershipRequest> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last membership request in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MembershipRequest findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchMembershipRequestException, SystemException {
		int count = countByCompanyId(companyId);

		List<MembershipRequest> list = findByCompanyId(companyId, count - 1,
	...
	/**
	 * Returns the membership requests before and after the current membership request in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MembershipRequest[] findByCompanyId_PrevAndNext(
		long membershipRequestId, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchMembershipRequestException, SystemException {
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, membershipRequest,
					companyId, orderByComparator, true);

			array[1] = membershipRequest;

			array[2] = getByCompanyId_PrevAndNext(session, membershipRequest,
	...
	protected MembershipRequest getByCompanyId_PrevAndNext(Session session,
		MembershipRequest membershipRequest, long companyId,
	...
	/**
	 * Removes all the membership requests where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (MembershipRequest membershipRequest : findByCompanyId(companyId)) {
	...
	/**
	 * Returns the number of membership requests where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "membershipRequest.companyId = ?";
