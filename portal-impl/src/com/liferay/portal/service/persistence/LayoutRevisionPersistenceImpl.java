...
public class LayoutRevisionPersistenceImpl extends BasePersistenceImpl<LayoutRevision>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(LayoutRevisionModelImpl.ENTITY_CACHE_ENABLED,
			...
			LayoutRevisionModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(LayoutRevisionModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !LayoutRevisionModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((layoutRevisionModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(layoutRevisionModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(layoutRevisionModelImpl.getCompanyId())
					};
	...
	/**
	 * Returns all the layout revisions where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching layout revisions
	 * @throws SystemException if a system exception occurred
	 */
	public List<LayoutRevision> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the layout revisions where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<LayoutRevision> findByCompanyId(long companyId, int start,
		int end) throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the layout revisions where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<LayoutRevision> findByCompanyId(long companyId, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (LayoutRevision layoutRevision : list) {
				if ((companyId != layoutRevision.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first layout revision in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LayoutRevision findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchLayoutRevisionException, SystemException {
		List<LayoutRevision> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last layout revision in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LayoutRevision findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchLayoutRevisionException, SystemException {
		int count = countByCompanyId(companyId);

		List<LayoutRevision> list = findByCompanyId(companyId, count - 1,
	...
	/**
	 * Returns the layout revisions before and after the current layout revision in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LayoutRevision[] findByCompanyId_PrevAndNext(long layoutRevisionId,
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, layoutRevision,
					companyId, orderByComparator, true);

			array[1] = layoutRevision;

			array[2] = getByCompanyId_PrevAndNext(session, layoutRevision,
	...
	protected LayoutRevision getByCompanyId_PrevAndNext(Session session,
		LayoutRevision layoutRevision, long companyId,
	...
	/**
	 * Removes all the layout revisions where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (LayoutRevision layoutRevision : findByCompanyId(companyId)) {
	...
	/**
	 * Returns the number of layout revisions where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "layoutRevision.companyId = ?";
