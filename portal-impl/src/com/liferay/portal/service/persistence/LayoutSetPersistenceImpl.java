...
public class LayoutSetPersistenceImpl extends BasePersistenceImpl<LayoutSet>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(LayoutSetModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !LayoutSetModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((layoutSetModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(layoutSetModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(layoutSetModelImpl.getCompanyId())
					};
	...
	/**
	 * Returns all the layout sets where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching layout sets
	 * @throws SystemException if a system exception occurred
	 */
	public List<LayoutSet> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the layout sets where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<LayoutSet> findByCompanyId(long companyId, int start, int end)
		throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the layout sets where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	/**
	 * Returns the first layout set in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LayoutSet findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchLayoutSetException, SystemException {
		List<LayoutSet> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last layout set in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LayoutSet findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchLayoutSetException, SystemException {
		int count = countByCompanyId(companyId);

		List<LayoutSet> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the layout sets before and after the current layout set in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LayoutSet[] findByCompanyId_PrevAndNext(long layoutSetId,
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, layoutSet,
					companyId, orderByComparator, true);

			array[1] = layoutSet;

			array[2] = getByCompanyId_PrevAndNext(session, layoutSet,
	...
	protected LayoutSet getByCompanyId_PrevAndNext(Session session,
		LayoutSet layoutSet, long companyId,
	...
	/**
	 * Removes all the layout sets where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (LayoutSet layoutSet : findByCompanyId(companyId)) {
			remove(layoutSet);
		}
	}
	...
	/**
	 * Returns the number of layout sets where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "layoutSet.companyId = ?";
