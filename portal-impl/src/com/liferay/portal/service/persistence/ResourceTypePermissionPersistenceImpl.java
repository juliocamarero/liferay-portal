...
public class ResourceTypePermissionPersistenceImpl extends BasePersistenceImpl<ResourceTypePermission>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(ResourceTypePermissionModelImpl.ENTITY_CACHE_ENABLED,
	...
	/**
	 * Returns all the resource type permissions where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching resource type permissions
	 * @throws SystemException if a system exception occurred
	 */
	public List<ResourceTypePermission> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the resource type permissions where companyId = &#63;.
	 *
	 * <p>
	...
	/**
	 * Returns an ordered range of all the resource type permissions where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	/**
	 * Returns the first resource type permission in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ResourceTypePermission findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchResourceTypePermissionException, SystemException {
		List<ResourceTypePermission> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last resource type permission in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ResourceTypePermission findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchResourceTypePermissionException, SystemException {
		int count = countByCompanyId(companyId);

		List<ResourceTypePermission> list = findByCompanyId(companyId,
	...
	/**
	 * Returns the resource type permissions before and after the current resource type permission in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ResourceTypePermission[] findByCompanyId_PrevAndNext(
		long resourceTypePermissionId, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchResourceTypePermissionException, SystemException {
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session,
					resourceTypePermission, companyId, orderByComparator, true);

			array[1] = resourceTypePermission;

			array[2] = getByCompanyId_PrevAndNext(session,
					resourceTypePermission, companyId, orderByComparator, false);
	...
	protected ResourceTypePermission getByCompanyId_PrevAndNext(
	...
	/**
	 * Removes all the resource type permissions where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (ResourceTypePermission resourceTypePermission : findByCompanyId(
				companyId)) {
	...
	/**
	 * Returns the number of resource type permissions where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "resourceTypePermission.companyId = ?";
