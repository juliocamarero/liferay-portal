...
public class ResourceBlockPersistenceImpl extends BasePersistenceImpl<ResourceBlock>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(ResourceBlockModelImpl.ENTITY_CACHE_ENABLED,
	...
	/**
	 * Returns all the resource blocks where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching resource blocks
	 * @throws SystemException if a system exception occurred
	 */
	public List<ResourceBlock> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the resource blocks where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ResourceBlock> findByCompanyId(long companyId, int start,
		int end) throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the resource blocks where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	/**
	 * Returns the first resource block in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ResourceBlock findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchResourceBlockException, SystemException {
		List<ResourceBlock> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last resource block in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ResourceBlock findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchResourceBlockException, SystemException {
		int count = countByCompanyId(companyId);

		List<ResourceBlock> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the resource blocks before and after the current resource block in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ResourceBlock[] findByCompanyId_PrevAndNext(long resourceBlockId,
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, resourceBlock,
					companyId, orderByComparator, true);

			array[1] = resourceBlock;

			array[2] = getByCompanyId_PrevAndNext(session, resourceBlock,
	...
	protected ResourceBlock getByCompanyId_PrevAndNext(Session session,
		ResourceBlock resourceBlock, long companyId,
	...
	/**
	 * Removes all the resource blocks where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (ResourceBlock resourceBlock : findByCompanyId(companyId)) {
	...
	/**
	 * Returns the number of resource blocks where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "resourceBlock.companyId = ?";
