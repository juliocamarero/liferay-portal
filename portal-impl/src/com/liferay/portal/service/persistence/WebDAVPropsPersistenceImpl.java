...
public class WebDAVPropsPersistenceImpl extends BasePersistenceImpl<WebDAVProps>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(WebDAVPropsModelImpl.ENTITY_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(WebDAVPropsModelImpl.ENTITY_CACHE_ENABLED,
			...
			WebDAVPropsModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(WebDAVPropsModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !WebDAVPropsModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((webDAVPropsModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(webDAVPropsModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(webDAVPropsModelImpl.getCompanyId())
					};
	...
	/**
	 * Returns all the web d a v propses where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching web d a v propses
	 * @throws SystemException if a system exception occurred
	 */
	public List<WebDAVProps> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the web d a v propses where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @return the range of matching web d a v propses
	 * @throws SystemException if a system exception occurred
	 */
	public List<WebDAVProps> findByCompanyId(long companyId, int start, int end)
		throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the web d a v propses where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @return the ordered range of matching web d a v propses
	 * @throws SystemException if a system exception occurred
	 */
	public List<WebDAVProps> findByCompanyId(long companyId, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (WebDAVProps webDAVProps : list) {
				if ((companyId != webDAVProps.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first web d a v props in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @return the first matching web d a v props
	 * @throws com.liferay.portal.NoSuchWebDAVPropsException if a matching web d a v props could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public WebDAVProps findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchWebDAVPropsException, SystemException {
		List<WebDAVProps> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last web d a v props in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching web d a v props
	 * @throws com.liferay.portal.NoSuchWebDAVPropsException if a matching web d a v props could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public WebDAVProps findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchWebDAVPropsException, SystemException {
		int count = countByCompanyId(companyId);

		List<WebDAVProps> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the web d a v propses before and after the current web d a v props in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 *
	 * @param webDavPropsId the primary key of the current web d a v props
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the previous, current, and next web d a v props
	 * @throws com.liferay.portal.NoSuchWebDAVPropsException if a web d a v props with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public WebDAVProps[] findByCompanyId_PrevAndNext(long webDavPropsId,
		long companyId, OrderByComparator orderByComparator)
		throws NoSuchWebDAVPropsException, SystemException {
		WebDAVProps webDAVProps = findByPrimaryKey(webDavPropsId);
		...
		try {
			...
			WebDAVProps[] array = new WebDAVPropsImpl[3];

			array[0] = getByCompanyId_PrevAndNext(session, webDAVProps,
					companyId, orderByComparator, true);

			array[1] = webDAVProps;

			array[2] = getByCompanyId_PrevAndNext(session, webDAVProps,
	...
	protected WebDAVProps getByCompanyId_PrevAndNext(Session session,
		WebDAVProps webDAVProps, long companyId,
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(webDAVProps);
	...
	/**
	 * Removes all the web d a v propses where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (WebDAVProps webDAVProps : findByCompanyId(companyId)) {
			remove(webDAVProps);
		}
	}
	...
	/**
	 * Returns the number of web d a v propses where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "webDAVProps.companyId = ?";
