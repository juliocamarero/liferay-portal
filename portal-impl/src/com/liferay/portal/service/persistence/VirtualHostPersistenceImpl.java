...
public class VirtualHostPersistenceImpl extends BasePersistenceImpl<VirtualHost>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(VirtualHostModelImpl.ENTITY_CACHE_ENABLED,
			VirtualHostModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<VirtualHost> findByCompanyId(long companyId, int start,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VirtualHost findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchVirtualHostException, SystemException {
		List<VirtualHost> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VirtualHost findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchVirtualHostException, SystemException {
		int count = countByCompanyId(companyId);

		List<VirtualHost> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VirtualHost[] findByCompanyId_PrevAndNext(long virtualHostId,
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, virtualHost,
					companyId, orderByComparator, true);

			array[1] = virtualHost;

			array[2] = getByCompanyId_PrevAndNext(session, virtualHost,
	...
	protected VirtualHost getByCompanyId_PrevAndNext(Session session,
		VirtualHost virtualHost, long companyId,
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(virtualHost);
	...
	public void removeByCompanyId(long companyId) throws SystemException {
		for (VirtualHost virtualHost : findByCompanyId(companyId)) {
			remove(virtualHost);
		}
	}
