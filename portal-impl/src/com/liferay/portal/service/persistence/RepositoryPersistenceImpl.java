...
public class RepositoryPersistenceImpl extends BasePersistenceImpl<Repository>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_ = "repository.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_ = "repository.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_ = "(repository.uuid_ IS NULL OR repository.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1_ = "repository.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_ = "repository.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_ = "(repository.uuid_ IS NULL OR repository.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_ = "repository.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_ = "repository.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_ = "(repository.uuid_ IS NULL OR repository.uuid_ = ?) AND ";
