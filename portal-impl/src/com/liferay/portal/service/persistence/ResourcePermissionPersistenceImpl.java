...
public class ResourcePermissionPersistenceImpl extends BasePersistenceImpl<ResourcePermission>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(ResourcePermissionModelImpl.ENTITY_CACHE_ENABLED,
	...
	/**
	 * Returns all the resource permissions where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching resource permissions
	 * @throws SystemException if a system exception occurred
	 */
	public List<ResourcePermission> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the resource permissions where companyId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ResourcePermission> findByCompanyId(long companyId, int start,
		int end) throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the resource permissions where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	/**
	 * Returns the first resource permission in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ResourcePermission findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchResourcePermissionException, SystemException {
		List<ResourcePermission> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last resource permission in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ResourcePermission findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchResourcePermissionException, SystemException {
		int count = countByCompanyId(companyId);

		List<ResourcePermission> list = findByCompanyId(companyId, count - 1,
	...
	/**
	 * Returns the resource permissions before and after the current resource permission in the ordered set where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ResourcePermission[] findByCompanyId_PrevAndNext(
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, resourcePermission,
					companyId, orderByComparator, true);

			array[1] = resourcePermission;

			array[2] = getByCompanyId_PrevAndNext(session, resourcePermission,
	...
	protected ResourcePermission getByCompanyId_PrevAndNext(Session session,
		ResourcePermission resourcePermission, long companyId,
	...
	/**
	 * Removes all the resource permissions where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (ResourcePermission resourcePermission : findByCompanyId(companyId)) {
	...
	/**
	 * Returns the number of resource permissions where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "resourcePermission.companyId = ?";
