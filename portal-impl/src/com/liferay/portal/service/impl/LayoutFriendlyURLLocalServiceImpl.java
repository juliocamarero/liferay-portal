...
public class LayoutFriendlyURLLocalServiceImpl
	...
	public String getLayoutFriendlyURL(long groupId, boolean privateLayout, String languageId) {
		LayoutFriendlyURL layoutFriendlyURL =
			layoutFriendlyURLPersistence.fetchByG_P_L(
				groupId, privateLayout, languageId);
