...
public class LayoutFriendlyURLModelImpl extends BaseModelImpl<LayoutFriendlyURL>
	...
	public static final String TABLE_SQL_CREATE = "create table LayoutFriendlyURL (uuid_ VARCHAR(75) null,layoutFriendlyURLId LONG not null primary key,groupId LONG,companyId LONG,plid LONG,privateLayout BOOLEAN,friendlyURL VARCHAR(75) null,locale VARCHAR(75) null)";
	...
	public static long LOCALE_COLUMN_BITMASK = 8L;
	...
	public Object clone() {
		...
		layoutFriendlyURLImpl.setLocale(getLocale());
	...
	public void resetOriginalValues() {
		...
		layoutFriendlyURLModelImpl._originalLocale = layoutFriendlyURLModelImpl._locale;
	...
	public CacheModel<LayoutFriendlyURL> toCacheModel() {
		...
		layoutFriendlyURLCacheModel.locale = getLocale();

		String locale = layoutFriendlyURLCacheModel.locale;

		if ((locale != null) && (locale.length() == 0)) {
			layoutFriendlyURLCacheModel.locale = null;
		}
