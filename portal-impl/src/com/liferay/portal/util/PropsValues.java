...
public class PropsValues {
	...
	public static final boolean ASSET_BROWSER_SEARCH_JOURNAL_ARTICLES_WITH_DATABASE = GetterUtil.getBoolean(PropsUtil.get(PropsKeys.ASSET_BROWSER_SEARCH_JOURNAL_ARTICLES_WITH_DATABASE));
