...
public class PropsValues {
	...
	public static final boolean JOURNAL_ARTICLES_PUBLISH_TO_LIVE_BY_DEFAULT = GetterUtil.getBoolean(PropsUtil.get(PropsKeys.JOURNAL_ARTICLES_PUBLISH_TO_LIVE_BY_DEFAULT));
