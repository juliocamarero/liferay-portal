...
public class PropsValues {
	...
	public static String RSS_FEED_FORMAT_DEFAULT = PropsUtil.get(PropsKeys.RSS_FEED_FORMAT_DEFAULT);

	public static String[] RSS_FEED_FORMATS = PropsUtil.getArray(PropsKeys.RSS_FEED_FORMATS);
