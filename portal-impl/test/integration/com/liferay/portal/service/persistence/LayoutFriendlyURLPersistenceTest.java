...
public class LayoutFriendlyURLPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newLayoutFriendlyURL.setLocale(ServiceTestUtil.randomString());
		...
		Assert.assertEquals(existingLayoutFriendlyURL.getLocale(),
			newLayoutFriendlyURL.getLocale());
	}
	...
	public void testResetOriginalValues() throws Exception {
		...
		Assert.assertTrue(Validator.equals(
				existingLayoutFriendlyURLModelImpl.getLocale(),
				existingLayoutFriendlyURLModelImpl.getOriginalLocale()));
	...
	protected LayoutFriendlyURL addLayoutFriendlyURL()
		...
		layoutFriendlyURL.setLocale(ServiceTestUtil.randomString());
