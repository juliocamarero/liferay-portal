...
public class JournalIndexerTest {
	...
	public void testMoveArticleToTrashAndRestore() throws Exception {
		...
		Assert.assertEquals(
			initialBaseModelsSearchCount + 1,
			searchCount(
				group.getGroupId(), WorkflowConstants.STATUS_IN_TRASH,
				searchContext));
	...
	protected int searchCount(
			long groupId, int status, SearchContext searchContext)
		throws Exception {
	...
	protected int searchCount(long groupId, SearchContext searchContext)
		...
		return searchCount(
			groupId, WorkflowConstants.STATUS_APPROVED, searchContext);
	}
