...
public class AssetPublisherServiceTest {
	...
	public static void setUpClass() throws Exception {
		...
		_permissionChecker = PermissionCheckerTestUtil.getPermissionChecker();
	}
	...
	public void testGetAssetEntries() throws Exception {
		...
		List<AssetEntry> entries = AssetPublisherUtil.getAssetEntries(
			...
			_permissionChecker, new long[] {_groupId}, _assetEntryXmls, false,
			false);
	...
	public void testGetAssetEntriesFilteredByCategories() throws Exception {
		...
		List<AssetEntry> entries = AssetPublisherUtil.getAssetEntries(
			new MockPortletRequest(), new MockPortletPreferences(),
			_permissionChecker, new long[] {_groupId}, _assetEntryXmls, false,
			false, allAssetCategoryIds, _NO_TAGS);
	...
	public void testGetAssetEntriesFilteredByCategoriesAndTags()
		...
		List<AssetEntry> entries = AssetPublisherUtil.getAssetEntries(
			new MockPortletRequest(), new MockPortletPreferences(),
			_permissionChecker, new long[] {_groupId}, _assetEntryXmls, false,
			false, allAssetCategoyIds, allAssetTagNames);
	...
	public void testGetAssetEntriesFilteredByTags() throws Exception {
		...
		List<AssetEntry> entries = AssetPublisherUtil.getAssetEntries(
			new MockPortletRequest(), new MockPortletPreferences(),
			_permissionChecker, new long[] {_groupId}, _assetEntryXmls, false,
			false, _NO_CATEGORIES, allAssetTagNames);
	...
	protected void _addArticles(
		...
		for (int i = 0; i < number; i++) {
			...
			JournalArticleLocalServiceUtil.updateAsset(
				_userId, article, categoryIds, tagNames, null);
			...
			AssetEntry assetEntry = AssetEntryLocalServiceUtil.getEntry(
				classNameId, articleResource.getPrimaryKey());
	...
	private void addJournalArticles(boolean hasCategories, boolean hasTags)
		throws Exception {
	...
	List<AssetEntry> _expectedEntries = new ArrayList<AssetEntry>();
