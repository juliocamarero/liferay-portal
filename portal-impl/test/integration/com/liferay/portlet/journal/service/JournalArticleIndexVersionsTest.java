...
public class JournalArticleIndexVersionsTest {
	...
	public void setUp() throws Exception {
		PropsValues.JOURNAL_ARTICLE_EXPIRE_ALL_VERSIONS = false;
	...
	public void tearDown() throws PortalException {
		PropsValues.JOURNAL_ARTICLE_EXPIRE_ALL_VERSIONS = GetterUtil.getBoolean(
			PropsUtil.get(PropsKeys.JOURNAL_ARTICLE_EXPIRE_ALL_VERSIONS));
	...
	public void testIndexVersions() throws Exception {
		...
		article = JournalTestUtil.expireArticle(
			_group.getGroupId(), article, article.getVersion());
		...
		Assert.assertEquals(
			article.getArticleId(), searchArticle.getArticleId());

		JournalTestUtil.updateArticle(article);
