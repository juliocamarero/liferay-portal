...
public abstract class BaseTrashHandlerTestCase {
	...
	@Test
	@Transactional
	public void testTrashMoveBaseModelAndDelete() throws Exception {
		trashMoveBaseModel(true);
	}

	@Test
	@Transactional
	public void testTrashMoveBaseModelAndRestore() throws Exception {
		trashMoveBaseModel(false);
	}
	...
	protected void trashMoveBaseModel(boolean delete) throws Exception {
		ServiceContext serviceContext = ServiceTestUtil.getServiceContext();
