...
public class UserNotificationEventUtil {
	...
	* @return the matching user notification events
	*/
	public static List<UserNotificationEvent> findByU_TY_DT_D(long userId,
		java.lang.String type, int deliveryType, boolean delivered) {
		return getPersistence()
				   .findByU_TY_DT_D(userId, type, deliveryType, delivered);
	}
	...
	* @throws NoSuchUserNotificationEventException if a matching user notification event could not be found
	*/
	public static UserNotificationEvent findByU_TY_DT_D_First(long userId,
		java.lang.String type, int deliveryType, boolean delivered,
		OrderByComparator<UserNotificationEvent> orderByComparator)
		throws com.liferay.portal.NoSuchUserNotificationEventException {
		return getPersistence()
				   .findByU_TY_DT_D_First(userId, type, deliveryType,
			delivered, orderByComparator);
	}
	...
	* @return the first matching user notification event, or <code>null</code> if a matching user notification event could not be found
	*/
	public static UserNotificationEvent fetchByU_TY_DT_D_First(long userId,
		java.lang.String type, int deliveryType, boolean delivered,
		OrderByComparator<UserNotificationEvent> orderByComparator) {
		return getPersistence()
				   .fetchByU_TY_DT_D_First(userId, type, deliveryType,
			delivered, orderByComparator);
	}
	...
	* @throws NoSuchUserNotificationEventException if a matching user notification event could not be found
	*/
	public static UserNotificationEvent findByU_TY_DT_D_Last(long userId,
		java.lang.String type, int deliveryType, boolean delivered,
		OrderByComparator<UserNotificationEvent> orderByComparator)
		throws com.liferay.portal.NoSuchUserNotificationEventException {
		return getPersistence()
				   .findByU_TY_DT_D_Last(userId, type, deliveryType, delivered,
			orderByComparator);
	}
	...
	* @return the last matching user notification event, or <code>null</code> if a matching user notification event could not be found
	*/
	public static UserNotificationEvent fetchByU_TY_DT_D_Last(long userId,
		java.lang.String type, int deliveryType, boolean delivered,
		OrderByComparator<UserNotificationEvent> orderByComparator) {
		return getPersistence()
				   .fetchByU_TY_DT_D_Last(userId, type, deliveryType,
			delivered, orderByComparator);
	}
	...
	* @throws NoSuchUserNotificationEventException if a user notification event with the primary key could not be found
	*/
	public static UserNotificationEvent[] findByU_TY_DT_D_PrevAndNext(
		long userNotificationEventId, long userId, java.lang.String type,
		int deliveryType, boolean delivered,
		OrderByComparator<UserNotificationEvent> orderByComparator)
		throws com.liferay.portal.NoSuchUserNotificationEventException {
		return getPersistence()
				   .findByU_TY_DT_D_PrevAndNext(userNotificationEventId,
	...
	* @param delivered the delivered
	*/
	public static void removeByU_TY_DT_D(long userId, java.lang.String type,
		int deliveryType, boolean delivered) {
		getPersistence().removeByU_TY_DT_D(userId, type, deliveryType, delivered);
	}
	...
	* @return the number of matching user notification events
	*/
	public static int countByU_TY_DT_D(long userId, java.lang.String type,
		int deliveryType, boolean delivered) {
		return getPersistence()
				   .countByU_TY_DT_D(userId, type, deliveryType, delivered);
	}
