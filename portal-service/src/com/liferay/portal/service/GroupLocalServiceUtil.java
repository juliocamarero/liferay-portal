...
public class GroupLocalServiceUtil {
	...
	*/
	...
	public static java.util.List<com.liferay.portal.model.Group> getLayoutScopes(
		long companyId, long parentGroupId, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getLayoutScopes(companyId, parentGroupId, start, end);
	}

	public static java.util.List<com.liferay.portal.model.Group> getLayoutScopes(
		long companyId, long parentGroupId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getLayoutScopes(companyId, parentGroupId);
	}

	public static int getLayoutScopesCount(long companyId, long parentGroupId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getLayoutScopesCount(companyId, parentGroupId);
	}
