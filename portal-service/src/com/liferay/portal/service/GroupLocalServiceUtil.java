...
public class GroupLocalServiceUtil {
	...
	*/
	public static java.util.List<com.liferay.portal.model.Group> search(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .search(companyId, parentGroupId, classNameIds, keywords,
			params, start, end);
	}
	...
	*/
	...
	/**
	* Returns a name ordered range of all the groups belonging to the parent
	* group that match the class name IDs, name, and description, optionally
	* including the user's inherited organization groups and user groups.
	* System and staged groups are not included.
	*
	* <p>
	...
	*/
	public static java.util.List<com.liferay.portal.model.Group> search(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .search(companyId, parentGroupId, classNameIds, name,
	...
	*/
	...
	/**
	* Returns a name ordered range of all the site groups belonging to the
	* parent group and organization groups that match the name and description,
	* optionally including the user's inherited organization groups and user
	* groups. System and staged groups are not included.
	*
	* <p>
	...
	*/
	public static int searchCount(long companyId, long parentGroupId,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .searchCount(companyId, parentGroupId, classNameIds,
			keywords, params);
	}
	...
	*/
	public static int searchCount(long companyId, long parentGroupId,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .searchCount(companyId, parentGroupId, classNameIds, name,
