...
public interface TrashHandler {
	...
	/**
	 * Checks if the user has the necessary permission for adding a trashed item
	 * to the container with the primary key.
	 *
	 * The permission can vary by portlet and is usually not tied to the item
	 * being moved but rather to the destination it is being moved to.
	 *
	 * @param  permissionChecker the permission checker
	 * @param  groupId the primary key of the group
	 * @param  containerModelId the primary key of the destination container
	 *         model
	 * @throws PortalException if the user didn't have the permission
