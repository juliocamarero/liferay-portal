...
public abstract class BasePortletDataHandler implements PortletDataHandler {
	...
	public PortletDataHandlerControl[] getExportConfigurationControls(
		...
		if ((PortletPreferencesLocalServiceUtil.getPortletPreferencesCount(
				...
				PortletKeys.PREFS_OWNER_TYPE_LAYOUT, portlet, plid,
				privateLayout) > 0) ||
		...
		if ((PortletPreferencesLocalServiceUtil.getPortletPreferencesCount(
				companyId, groupId, -1, PortletKeys.PREFS_OWNER_TYPE_USER,
				portlet, plid, privateLayout) > 0) ||
			(PortletPreferencesLocalServiceUtil.getPortletPreferencesCount(
				companyId, groupId, groupId, PortletKeys.PREFS_OWNER_TYPE_USER,
				portlet, PortletKeys.PREFS_PLID_SHARED, privateLayout) > 0)) {
