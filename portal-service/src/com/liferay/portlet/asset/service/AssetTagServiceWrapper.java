...
public class AssetTagServiceWrapper implements AssetTagService,
	...
	*/
	...
	@Override
	public int getVisibleTagsCount(long groupId, long classNameId,
		java.lang.String name) {
		return _assetTagService.getVisibleTagsCount(groupId, classNameId, name);
	}

	@Override
	public int getVisibleTagsCount(long groupId, java.lang.String name) {
		return _assetTagService.getVisibleTagsCount(groupId, name);
	}
