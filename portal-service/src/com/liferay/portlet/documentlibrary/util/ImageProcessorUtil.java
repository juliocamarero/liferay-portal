...
public class ImageProcessorUtil {
	...
	public static InputStream getCustom1AsStream(FileVersion fileVersion)
		...
		return getImageProcessor().getCustom1AsStream(fileVersion);
	}

	public static long getCustom1FileSize(FileVersion fileVersion)
		throws Exception {

		return getImageProcessor().getCustom1FileSize(fileVersion);
	}

	public static InputStream getCustom2AsStream(FileVersion fileVersion)
		throws Exception {

		return getImageProcessor().getCustom2AsStream(fileVersion);
	}

	public static long getCustom2FileSize(FileVersion fileVersion)
		throws Exception {

		return getImageProcessor().getCustom2FileSize(fileVersion);
	}
	...
	public static InputStream getThumbnailAsStream(FileVersion fileVersion)
		...
		return getImageProcessor().getThumbnailAsStream(fileVersion);
	}

	public static long getThumbnailFileSize(FileVersion fileVersion)
		throws Exception {

		return getImageProcessor().getThumbnailFileSize(fileVersion);
	}
	...
	public static boolean hasThumbnailImage(FileVersion fileVersion) {
		return getImageProcessor().hasThumbnailImage(fileVersion);
	}
